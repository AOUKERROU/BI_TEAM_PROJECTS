...
out1Struct out1 = new out1Struct();
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:5lLvbzR0mEgbAi3vKmBPX/ub4y1eT8XF313XC6a648WNz/mi").substring(0, 4) + "...");     
                        log4jParamters_tDBOutput_1.append(" | ");
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:/Qo8J9Pi/gjg0IpFZkUf9gS5sU8R5hIxa3fasv5RnwyBWzxd");
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:8MSJ4KREoEvBX79o2qRZtwZJG5yXnErLiBvjcPbZ6e3F8A==").substring(0, 4) + "...");     
                        log4jParamters_tDBInput_1.append(" | ");
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FUMEFgwrmCecZN1rgj7cLkDvPxFCIUCEELUTk63Cl3gXZA==");
