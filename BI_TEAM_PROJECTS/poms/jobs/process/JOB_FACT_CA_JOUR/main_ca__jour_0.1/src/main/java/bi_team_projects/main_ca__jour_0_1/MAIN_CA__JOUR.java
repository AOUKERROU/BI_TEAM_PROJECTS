...
package bi_team_projects.main_ca__jour_0_1;
...
/**
 * Job: MAIN_CA__JOUR Purpose: <br>
 * Description:  <br>
 * @author oukerrou, Ayoub
 * @version 8.0.1.20220317_0634-patch
 * @status 
 */
public class MAIN_CA__JOUR implements TalendJob {
	static {System.setProperty("TalendJob.log", "MAIN_CA__JOUR.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(MAIN_CA__JOUR.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MAIN_CA__JOUR";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_4OBicHHQEeutNJWIfQHYSg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MAIN_CA__JOUR.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MAIN_CA__JOUR.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:e4XB+20bkoVS05c7rsttLZtW7qB+lu5Igyzq0+Mq+nZaSXU=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:hMNCvwaxaNGwyBx0PcpHsewjFygec/jnVipPcJRTQWSyguM=");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tRunJob_2";
		...
		int tos_count_tRunJob_2 = 0;
                ...
                class BytesLimit65535_tRunJob_2{
                    ...
                    log4jParamters_tRunJob_2.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("PROCESS" + " = " + "DWH__CA__JOURS");
                        log4jParamters_tRunJob_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tRunJob_2", "CA_JOUR_DWH", "tRunJob");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		bi_team_projects.dwh__ca__jours_0_1.DWH__CA__JOURS childJob_tRunJob_2 = new bi_team_projects.dwh__ca__jours_0_1.DWH__CA__JOURS();
	    // pass DataSources
	    ...
	    if (null != talendDataSources_tRunJob_2) {
			...
			log.info("tRunJob_2 - The child job 'bi_team_projects.dwh__ca__jours_0_1.DWH__CA__JOURS' starts on the version '0.1' with the context 'Default'.");
		...
		String[][] childReturn_tRunJob_2 = childJob_tRunJob_2.runJob((String[]) paraList_tRunJob_2.toArray(new String[paraList_tRunJob_2.size()]));
			...
			log.info("tRunJob_2 - The child job 'bi_team_projects.dwh__ca__jours_0_1.DWH__CA__JOURS' is done.");
 ...
 */
    ...
    public static void main(String[] args){
        final MAIN_CA__JOUR MAIN_CA__JOURClass = new MAIN_CA__JOUR();

        int exitCode = MAIN_CA__JOURClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'MAIN_CA__JOUR' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'MAIN_CA__JOUR' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = MAIN_CA__JOUR.class.getClassLoader().getResourceAsStream("bi_team_projects/main_ca__jour_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MAIN_CA__JOUR.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MAIN_CA__JOUR");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     63964 characters generated by Talend Cloud Data Management Platform 
 *     on the 21 juillet 2022 à 17:17:59 WEST
 ************************************************************************************************/