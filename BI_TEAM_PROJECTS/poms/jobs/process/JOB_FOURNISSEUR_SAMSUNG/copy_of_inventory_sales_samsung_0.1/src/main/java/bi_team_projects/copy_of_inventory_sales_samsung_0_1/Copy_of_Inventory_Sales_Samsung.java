...
package bi_team_projects.copy_of_inventory_sales_samsung_0_1;
...
/**
 * Job: Copy_of_Inventory_Sales_Samsung Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_Inventory_Sales_Samsung implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_Inventory_Sales_Samsung.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Copy_of_Inventory_Sales_Samsung.class);
	...
	private final String jobName = "Copy_of_Inventory_Sales_Samsung";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_Inventory_Sales_Samsung.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_Inventory_Sales_Samsung.this,
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileList_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileList_1.append(
									"DIRECTORY" + " = " + "\"C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT\"");
							log4jParamters_tFileList_1.append(" | ");
				...
				String directory_tFileList_1 = "C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT";
	...
	public static class out_sStruct implements routines.system.IPersistableRow<out_sStruct> {
		final static byte[] commonByteArrayLock_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung = new byte[0];
		static byte[] commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung.length) {
					if (length < 1024 && commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung.length == 0) {
						commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung = new byte[1024];
					} else {
						commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung, 0, length);
				strReturn = new String(commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung, 0, length);
				strReturn = new String(commonByteArray_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BI_TEAM_PROJECTS_Copy_of_Inventory_Sales_Samsung) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = "
									+ "\"C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT/MCSEDI_C780_MARJANE_SO_SKU_\"+((String)globalMap.get(\"CurentDate\"))+\".txt\"");
							log4jParamters_tFileOutputDelimited_1.append(" | ");
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT/MCSEDI_C780_MARJANE_SO_SKU_"
								+ ((String) globalMap.get("CurentDate")) + ".txt")).getAbsolutePath().replace("\\",
										"/");
...
// ###############################
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:NjU5bABjHNWTvqN6iUKS7Js7eZrjPOFCULp3KoD3wPFcLQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Dbce1rwvw3sRc1I07BQQK3jbJF9CY8h4kdyBDVqwUgTivQ==");
...
// # Output table : 'out_s'
							...
							out_s = out_s_tmp;
							log.debug("tMap_1 - Outputting the record " + count_out_s_tMap_1
									+ " of the output table 'out_s'.");
...
// Start of branch "out_s"
						if (out_s != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "out_s", "tMap_1", "tMap_1", "tMap", "tFileOutputDelimited_1", "output_marjane",
							...
							if (out_s.SUBS != null) {
								sb_tFileOutputDelimited_1.append(out_s.SUBS);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.DATATYPE != null) {
								sb_tFileOutputDelimited_1.append(out_s.DATATYPE);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.SALESDATE != null) {
								sb_tFileOutputDelimited_1.append(out_s.SALESDATE);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (out_s.TOSITE != null) {
								sb_tFileOutputDelimited_1.append(out_s.TOSITE);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.SERIALNO != null) {
								sb_tFileOutputDelimited_1.append(out_s.SERIALNO);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.MODEL != null) {
								sb_tFileOutputDelimited_1.append(out_s.MODEL);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.QTY != null) {
								sb_tFileOutputDelimited_1.append(out_s.QTY.toPlainString());
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.BRAND != null) {
								sb_tFileOutputDelimited_1.append(out_s.BRAND);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.PRODUCT != null) {
								sb_tFileOutputDelimited_1.append(out_s.PRODUCT);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.PRICE != null) {
								sb_tFileOutputDelimited_1.append(out_s.PRICE);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.DATACOLLECTOR != null) {
								sb_tFileOutputDelimited_1.append(out_s.DATACOLLECTOR);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE01 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE01);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE02 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE02);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE03 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE03);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE04 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE04);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE05 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE05);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE06 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE06);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE07 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE07);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE08 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE08);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE09 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE09);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.ATTRIBUTE10 != null) {
								sb_tFileOutputDelimited_1.append(out_s.ATTRIBUTE10);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.CREATE_ID != null) {
								sb_tFileOutputDelimited_1.append(out_s.CREATE_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (out_s.CREATE_DT != null) {
								sb_tFileOutputDelimited_1.append(out_s.CREATE_DT);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "out_s", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tFileOutputDelimited_1", "output_marjane", "tFileOutputDelimited",
						"output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = "
									+ "\"C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT/OUTPUT/MCSEDI_C780_ELECTROPLANET_SO_SKU_\"+((String)globalMap.get(\"CurentDate\"))+\".txt\"");
							log4jParamters_tFileOutputDelimited_2.append(" | ");
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT/OUTPUT/MCSEDI_C780_ELECTROPLANET_SO_SKU_"
								+ ((String) globalMap.get("CurentDate")) + ".txt")).getAbsolutePath().replace("\\",
										"/");
...
// ###############################
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:VZl/vDXtPzQr9laLoCh4PXjl25jF85aEOV/JP6NEtAOp9A==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_2.append(" | ");
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ovOAOolxG69xgQ1JEH3CE99XIR8S7C3f62PNmAnEq0oNhA==");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "input_electroplanet", "tOracleInput", "tMap_2", "tMap_2",
								"tMap"
...
// # Output table : 'copyOfout_s'
							...
							log.debug("tMap_2 - Outputting the record " + count_copyOfout_s_tMap_2
									+ " of the output table 'copyOfout_s'.");
...
// Start of branch "copyOfout_s"
						if (copyOfout_s != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "copyOfout_s", "tMap_2", "tMap_2", "tMap", "tFileOutputDelimited_2", "output_ep",
									"tFileOutputDelimited"
							...
							if (copyOfout_s.SUBS != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.SUBS);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.DATATYPE != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.DATATYPE);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.SALESDATE != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.SALESDATE);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.FROMSITE != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.FROMSITE
										.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.TOSITE != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.TOSITE);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.SERIALNO != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.SERIALNO);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.MODEL != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.MODEL);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.QTY != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.QTY.toPlainString());
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.BRAND != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.BRAND);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.PRODUCT != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.PRODUCT);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.PRICE != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.PRICE);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.DATACOLLECTOR != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.DATACOLLECTOR);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE01 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE01);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE02 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE02);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE03 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE03);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE04 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE04);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE05 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE05);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE06 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE06);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE07 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE07);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE08 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE08);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE09 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE09);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.ATTRIBUTE10 != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.ATTRIBUTE10);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.CREATE_ID != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.CREATE_ID);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (copyOfout_s.CREATE_DT != null) {
								sb_tFileOutputDelimited_2.append(copyOfout_s.CREATE_DT);
							}
...
// ###############################      
				log.debug(
						"tMap_2 - Written records count in the table 'copyOfout_s': " + count_copyOfout_s_tMap_2 + ".");
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "copyOfout_s", 2, 0,
						"tMap_2", "tMap_2", "tMap", "tFileOutputDelimited_2", "output_ep", "tFileOutputDelimited",
						"output")) {
					talendJobLogProcess(globalMap);
				}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFTPConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFTPConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:XhWKxp4Oi5VF7ACasgwjM5OQ76PTLu++EgN2oRbBeOCG+45zcy9Ftg==")
									.substring(0, 4) + "...");
							log4jParamters_tFTPConnection_1.append(" | ");
				...
				class MyUserInfo implements com.jcraft.jsch.UserInfo, com.jcraft.jsch.UIKeyboardInteractive {
					...
					String decryptedPassphrase_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:QATAGaW0/+515/Am4SNszhJM/yk+fzjCLjMhFoLi+fvhNw==");
					...
					public String getPassword() {
						...
						final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:i0diW/xYDnTzDc4d0M+FndgB5ku908bbY9Ts0g8eJy9JvK3zAn8UOQ==");
				...
				do {
					...
					final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil
							.decryptPassword(
									"enc:routine.encryption.key.v1:hHI/KWlpp+vykvgLkFz3pQm7k/f04LUsMKp8UN4VHwSX5cl2Wyl+wg==");
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFTPPut_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFTPPut_1.append(" | ");
							log4jParamters_tFTPPut_1.append(
									"LOCALDIR" + " = " + "\"C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT\"");
							log4jParamters_tFTPPut_1.append(" | ");
...
// *** sftp *** //
				...
				String localdirtFTPPut_1 = "C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT";
...
// *** sftp *** //
				...
				String localdirtFTPPut_2 = "C:/Users/aoukerrou/Desktop/sql/portail frn/OUTPUT";
	...
	public static void main(String[] args) {
		final Copy_of_Inventory_Sales_Samsung Copy_of_Inventory_Sales_SamsungClass = new Copy_of_Inventory_Sales_Samsung();

		int exitCode = Copy_of_Inventory_Sales_SamsungClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_Inventory_Sales_Samsung' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Copy_of_Inventory_Sales_Samsung' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_Inventory_Sales_Samsung.class.getClassLoader().getResourceAsStream(
					"bi_team_projects/copy_of_inventory_sales_samsung_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_Inventory_Sales_Samsung.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_Inventory_Sales_Samsung");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 293256 characters generated by Talend Cloud Data Management Platform on the
 * 25 juillet 2022 à 16:29:25 WEST
 ************************************************************************************************/