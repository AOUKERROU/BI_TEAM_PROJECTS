...
public class Inventory_Sales_Samsung implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Inventory_Sales_Samsung.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Inventory_Sales_Samsung.class);
					...
					class BytesLimit65535_tFileList_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileList_1
									.append("DIRECTORY" + " = " + "\"E:/Talend/OUTPUT FILES/SUMSUNG PRT FRNS\"");
	...
	public static class out_sStruct implements routines.system.IPersistableRow<out_sStruct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				strReturn = new String(commonByteArray_BI_TEAM_PROJECTS_Inventory_Sales_Samsung, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = "
									+ "\"E:/Talend/OUTPUT FILES/SUMSUNG PRT FRNS/MCSEDI_C780_MARJANE_SO_SKU_\"+((String)globalMap.get(\"CurentDate\"))+\".txt\"");
							log4jParamters_tFileOutputDelimited_1.append(" | ");
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"E:/Talend/OUTPUT FILES/SUMSUNG PRT FRNS/MCSEDI_C780_MARJANE_SO_SKU_"
...
// ###############################
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:qWhFlPCJf62Mt9A/73RKdMeQLwHPjhXLuNFGKgFB5lYEhQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:+kJFoLUZFJtPBIZb+M8/ttweZL9Ew0kXgJi/bdYGzrhg6Q==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = "
									+ "\"E:/Talend/OUTPUT FILES/SUMSUNG PRT FRNS/OUTPUT/MCSEDI_C780_ELECTROPLANET_SO_SKU_\"+((String)globalMap.get(\"CurentDate\"))+\".txt\"");
							log4jParamters_tFileOutputDelimited_2.append(" | ");
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"E:/Talend/OUTPUT FILES/SUMSUNG PRT FRNS/OUTPUT/MCSEDI_C780_ELECTROPLANET_SO_SKU_"
								+ ((String) globalMap.get("CurentDate")) + ".txt")).getAbsolutePath().replace("\\",
										"/");
...
// ###############################
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:VJFI6Bd83TV/qvy6o4Gq27r9xVuggcMgAcn+0zqIQ8TVjQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_2.append(" | ");
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:aMkwmYWP6o/9JMHLotZRRcK2IMIK2BxgyyLNO3bEBsVCpg==");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFTPConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFTPConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:l7ltqYAO9BnBSfClnj60Irxm9zrHYwjhfgC9JMoAu/phce6sE1CMIA==")
									.substring(0, 4) + "...");
							log4jParamters_tFTPConnection_1.append(" | ");
				...
				class MyUserInfo implements com.jcraft.jsch.UserInfo, com.jcraft.jsch.UIKeyboardInteractive {
					...
					String decryptedPassphrase_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:ltPNM03LDdV3u3e49BUJmKuBQrQeVv+8CsAx5CVQVP1aZg==");
					...
					public String getPassword() {
						...
						final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:0RXCdE6WFSqoJLlbXoNQwMebgnmVsZwNrKRgryFSapghbTZoG7Y+kQ==");
				...
				do {
					...
					final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil
							.decryptPassword(
									"enc:routine.encryption.key.v1:uV0ZKr2FoxQI2QO2YNpR3hr0Am8Z2w/8AMTgfllQS6pVTxEY7p99kw==");
...
// *** sftp *** //
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Inventory_Sales_Samsung.class.getClassLoader().getResourceAsStream(
					"bi_team_projects/inventory_sales_samsung_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Inventory_Sales_Samsung.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Inventory_Sales_Samsung");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 292500 characters generated by Talend Cloud Data Management Platform on the
 * 25 juillet 2022 à 16:08:33 WEST
 ************************************************************************************************/