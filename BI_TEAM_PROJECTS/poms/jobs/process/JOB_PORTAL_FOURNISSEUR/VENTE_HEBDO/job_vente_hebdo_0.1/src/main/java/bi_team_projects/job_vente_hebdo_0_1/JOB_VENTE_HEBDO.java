...
public class JOB_VENTE_HEBDO implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "JOB_VENTE_HEBDO.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(JOB_VENTE_HEBDO.class);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (conn_tDBClose_2 != null && !conn_tDBClose_2.isClosed()) {
					if (log.isDebugEnabled())
						log.debug("tDBClose_2 - " + ("Closing the connection ") + ("conn_tDBConnection_5")
								+ (" to the database."));
					conn_tDBClose_2.close();
					if (log.isDebugEnabled())
						log.debug("tDBClose_2 - " + ("Connection ") + ("conn_tDBConnection_5")
	...
	public void tDBConnection_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBConnection_5 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_5
									.append("HOST" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Server");
							log4jParamters_tDBConnection_5.append(" | ");
							log4jParamters_tDBConnection_5
									.append("PORT" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Port");
							...
							log4jParamters_tDBConnection_5
									.append("USER" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Login");
							log4jParamters_tDBConnection_5.append(" | ");
							log4jParamters_tDBConnection_5.append("PASS" + " = "
									+ String.valueOf(routines.system.PasswordEncryptUtil
											.encryptPassword(context.PORTAIL_FOURNISSEUR_AZURE_Password))
											.substring(0, 4)
									+ "...");
				...
				url_tDBConnection_5 += ";appName=" + projectName + ";"
						+ context.PORTAIL_FOURNISSEUR_AZURE_AdditionalParams;
				...
				log.debug("tDBConnection_5 - Connection attempt to '" + url_tDBConnection_5 + "' with the username '"
						+ dbUser_tDBConnection_5 + "'.");
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				boolean isShareIdentity_tDBOutput_2 = globalMap.get("shareIdentitySetting_tDBConnection_5") != null
						&& (Boolean) globalMap.get("shareIdentitySetting_tDBConnection_5") == true;
...
// ###############################
				...
				org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2
						.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_HEBDO_" + pid + "_tHashOutput_1");
...
// Start of branch "OUTFRN"
				...
				org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
						.remove("tHashFile_JOB_VENTE_HEBDO_" + pid + "_tHashOutput_1");
...
// ###############################      
	...
	public void tHashInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tHashInput_3 - inputs:(after_tHashInput_2) outputs:(row7,row7) |
				...
				org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3
						.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_HEBDO_" + pid + "_tHashOutput_2");
				...
				org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
						.remove("tHashFile_JOB_VENTE_HEBDO_" + pid + "_tHashOutput_2");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JOB_VENTE_HEBDO.class.getClassLoader()
					.getResourceAsStream("bi_team_projects/job_vente_hebdo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = JOB_VENTE_HEBDO.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : JOB_VENTE_HEBDO");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 536540 characters generated by Talend Cloud Data Management Platform on the
 * 21 juillet 2022 à 15:42:59 WEST
 ************************************************************************************************/