...
package bi_team_projects.job_vente_hebdo_0_1;
...
/**
 * Job: JOB_VENTE_HEBDO Purpose: <br>
 * Description:  <br>
 * @author oukerrou, Ayoub
 * @version 8.0.1.20220317_0634-patch
 * @status 
 */
public class JOB_VENTE_HEBDO implements TalendJob {
	static {System.setProperty("TalendJob.log", "JOB_VENTE_HEBDO.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(JOB_VENTE_HEBDO.class);
...
public String getPORTAIL_FOURNISSEUR_AZURE_Database(){
	...
	private final String jobName = "JOB_VENTE_HEBDO";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_uMLowKRrEeyC17RJB_lgug", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				JOB_VENTE_HEBDO.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(JOB_VENTE_HEBDO.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_JOB_VENTE_HEBDO_" + pid + "_tHashOutput_1";
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"Select FOUCFIN,LIBFRS, FOUCNUF  from Fournisseur  where ISABONNE = 1  order by FOUCFIN\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("FOUCFIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LIBFRS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("FOUCNUF")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_2", "PORTAIL_FOURNISSEUR_AZURE", "tMSSqlInput");
				talendJobLogProcess(globalMap);
			}
		    ...
		    String dbquery_tDBInput_2 = "Select FOUCFIN,LIBFRS, FOUCNUF\nfrom Fournisseur\nwhere ISABONNE = 1\norder by FOUCFIN";
            ...
            row3.FOUCFIN = rs_tDBInput_2.getInt(1);
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.LIBFRS = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row3.LIBFRS = tmpContent_tDBInput_2;
                }
            } else {
                row3.LIBFRS = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.FOUCNUF = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row3.FOUCNUF = tmpContent_tDBInput_2;
                }
            } else {
                row3.FOUCNUF = null;
            }
 ...
 */
	...
	currentComponent="tHashOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_2","PORTAIL_FOURNISSEUR_AZURE","tMSSqlInput","tHashOutput_1","FOURNISSEUR","tHashOutput"
...
globalMap.put("tHashOutput_1_NB_LINE", nb_line_tHashOutput_1);
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_2","PORTAIL_FOURNISSEUR_AZURE","tMSSqlInput","tHashOutput_1","FOURNISSEUR","tHashOutput","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBClose_4";
		...
		int tos_count_tDBClose_4 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBClose_4{
                    ...
                    log4jParamters_tDBClose_4.append("Parameters:");
                            log4jParamters_tDBClose_4.append("CONNECTION" + " = " + "tDBConnection_2");
                        log4jParamters_tDBClose_4.append(" | ");
                            log4jParamters_tDBClose_4.append("UNIFIED_COMPONENTS" + " = " + "tMSSqlClose");
                        log4jParamters_tDBClose_4.append(" | ");
                if(log.isDebugEnabled())
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBClose_4", "tDBClose_4", "tMSSqlClose");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	{
                if(log.isDebugEnabled())
            log.debug("tDBClose_4 - "  + ("Closing the connection ")  + ("conn_tDBConnection_2")  + (" to the database.") );
        conn_tDBClose_4.close();
                if(log.isDebugEnabled())
            log.debug("tDBClose_4 - "  + ("Connection ")  + ("conn_tDBConnection_2")  + (" to the database has closed.") );
	}
    ...
    String tableName_tDBOutput_1 = null;
        ...
        if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
            ...
            log.debug("tDBOutput_1 - "  + ("Truncate")  + (" table '")  + (tableName_tDBOutput_1)  + ("' has succeeded.") );
                ...
                String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1 + " (CODE_INTERNE_ARTICLE,CODESITE,EAN,DATE_DEBUT,DATE_FIN,CODEENSEIGNE,CODE_ARTICLE,QTE,CA_TTC,CA_HT,DateLastUpdateWebJob) VALUES (?,?,?,?,?,?,?,?,?,?,?)";    
                ...
                class BytesLimit65535_tAggregateRow_1_AGGOUT{
                    ...
                    log4jParamters_tAggregateRow_1_AGGOUT.append("Parameters:");
                        ...
                        log4jParamters_tAggregateRow_1_AGGOUT.append(" | ");
                            log4jParamters_tAggregateRow_1_AGGOUT.append("GROUPBYS" + " = " + "[{OUTPUT_COLUMN="+("FOUCFIN")+", INPUT_COLUMN="+("FOUCFIN")+"}, {OUTPUT_COLUMN="+("FOULIB")+", INPUT_COLUMN="+("FOULIB")+"}, {OUTPUT_COLUMN="+("FOUCNUF")+", INPUT_COLUMN="+("FOUCNUF")+"}]");
                        log4jParamters_tAggregateRow_1_AGGOUT.append(" | ");
                            log4jParamters_tAggregateRow_1_AGGOUT.append("OPERATIONS" + " = " + "[{OUTPUT_COLUMN="+("COUNTFRN")+", INPUT_COLUMN="+("FOUCFIN")+", IGNORE_NULL="+("false")+", FUNCTION="+("count")+"}]");
                        log4jParamters_tAggregateRow_1_AGGOUT.append(" | ");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_INTERNE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODESITE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EAN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_DEBUT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_FIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODEENSEIGNE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("QTE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_TTC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_HT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DateLastUpdateWebJob")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("FOUCIN")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.FOUCFIN = '" + row5HashKey.FOUCFIN + "'");
								} // G 071
...
fouci = fouci_tmp;
log.debug("tMap_1 - Outputting the record " + count_fouci_tMap_1 + " of the output table 'fouci'.");
...
} else {pstmt_tDBOutput_1.setLong(1, out1.CODE_INTERNE_ARTICLE);
}

                        if(out1.CODESITE == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(2, out1.CODESITE);
}

                        if(out1.EAN == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(3, out1.EAN);
}

                        if(out1.DATE_DEBUT != null) {
pstmt_tDBOutput_1.setObject(4, new java.sql.Timestamp(out1.DATE_DEBUT.getTime()),java.sql.Types.DATE);
} else {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.DATE);
}

                        if(out1.DATE_FIN != null) {
pstmt_tDBOutput_1.setObject(5, new java.sql.Timestamp(out1.DATE_FIN.getTime()),java.sql.Types.DATE);
} else {
...
} else {pstmt_tDBOutput_1.setLong(6, out1.CODEENSEIGNE);
}

                        if(out1.CODE_ARTICLE == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(7, out1.CODE_ARTICLE);
}
...
pstmt_tDBOutput_1.setObject(11, new java.sql.Timestamp(out1.DateLastUpdateWebJob.getTime()),java.sql.Types.DATE);
} else {
...
if(fouci != null) { 
	...
	currentComponent="tAggregateRow_1_AGGOUT";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"fouci","tMap_1","tMap_1","tMap","tAggregateRow_1_AGGOUT","tAggregateRow_1_AGGOUT","tAggregateOut"
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGOUT";
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"fouci",2,0,
			 			"tMap_1","tMap_1","tMap","tAggregateRow_1_AGGOUT","tAggregateRow_1_AGGOUT","tAggregateOut","output")) {
						talendJobLogProcess(globalMap);
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_JOB_VENTE_HEBDO_" + pid + "_tHashOutput_2";
                ...
                class BytesLimit65535_tAggregateRow_1_AGGIN{
                    ...
                    log4jParamters_tAggregateRow_1_AGGIN.append("Parameters:");
                        ...
                        log4jParamters_tAggregateRow_1_AGGIN.append(" | ");
                            log4jParamters_tAggregateRow_1_AGGIN.append("GROUPBYS" + " = " + "[{OUTPUT_COLUMN="+("FOUCFIN")+", INPUT_COLUMN="+("FOUCFIN")+"}, {OUTPUT_COLUMN="+("FOULIB")+", INPUT_COLUMN="+("FOULIB")+"}, {OUTPUT_COLUMN="+("FOUCNUF")+", INPUT_COLUMN="+("FOUCNUF")+"}]");
                        log4jParamters_tAggregateRow_1_AGGIN.append(" | ");
                            log4jParamters_tAggregateRow_1_AGGIN.append("OPERATIONS" + " = " + "[{OUTPUT_COLUMN="+("COUNTFRN")+", INPUT_COLUMN="+("FOUCFIN")+", IGNORE_NULL="+("false")+", FUNCTION="+("count")+"}]");
                        log4jParamters_tAggregateRow_1_AGGIN.append(" | ");
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
                ...
                if(log.isDebugEnabled())
            log.debug("tAggregateRow_1_AGGIN - "  + ("Operation function: 'count' on the column 'FOUCFIN'.") );
 ...
 */
	...
	currentComponent="tHashOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tAggregateRow_1_AGGIN","tAggregateRow_1_AGGIN","tAggregateIn","tHashOutput_2","COUNTFRN","tHashOutput"
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_5";
		...
		int tos_count_tDBConnection_5 = 0;
                ...
                if(log.isDebugEnabled())
            log.debug("tDBConnection_5 - "  + ("Start to work.") );
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_5{
                    public void limitLog4jByte() throws Exception{
                    StringBuilder log4jParamters_tDBConnection_5 = new StringBuilder();
                    log4jParamters_tDBConnection_5.append("Parameters:");
                            log4jParamters_tDBConnection_5.append("DRIVER" + " = " + "JTDS");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("HOST" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Server");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("PORT" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Port");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("SCHEMA_DB" + " = " + "\"\"");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("DBNAME" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Database");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("USER" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Login");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.PORTAIL_FOURNISSEUR_AZURE_Password)).substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("PROPERTIES" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_AdditionalParams");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("USE_SHARED_CONNECTION" + " = " + "false");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("SPECIFY_DATASOURCE_ALIAS" + " = " + "false");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("AUTO_COMMIT" + " = " + "false");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("SHARE_IDENTITY_SETTING" + " = " + "true");
                        log4jParamters_tDBConnection_5.append(" | ");
                            log4jParamters_tDBConnection_5.append("UNIFIED_COMPONENTS" + " = " + "tMSSqlConnection");
                        log4jParamters_tDBConnection_5.append(" | ");
                if(log.isDebugEnabled())
            log.debug("tDBConnection_5 - "  + (log4jParamters_tDBConnection_5) );
                    } 
                } 
            new BytesLimit65535_tDBConnection_5().limitLog4jByte();
            }
			if(enableLogStash) {
				talendJobLog.addCM("tDBConnection_5", "MSS AZURE", "tMSSqlConnection");
				talendJobLogProcess(globalMap);
			}
			...
			String url_tDBConnection_5 = "jdbc:jtds:sqlserver://" + context.PORTAIL_FOURNISSEUR_AZURE_Server ;
		String port_tDBConnection_5 = context.PORTAIL_FOURNISSEUR_AZURE_Port;
		String dbname_tDBConnection_5 = context.PORTAIL_FOURNISSEUR_AZURE_Database ;
    	if (!"".equals(port_tDBConnection_5)) {
    		url_tDBConnection_5 += ":" + context.PORTAIL_FOURNISSEUR_AZURE_Port;
    	}
    	if (!"".equals(dbname_tDBConnection_5)) {
    		
				url_tDBConnection_5 += "//" + context.PORTAIL_FOURNISSEUR_AZURE_Database; 
    	}

		url_tDBConnection_5 += ";appName=" + projectName + ";" + context.PORTAIL_FOURNISSEUR_AZURE_AdditionalParams;  
	String dbUser_tDBConnection_5 = context.PORTAIL_FOURNISSEUR_AZURE_Login;
	
	
		
	final String decryptedPassword_tDBConnection_5 = context.PORTAIL_FOURNISSEUR_AZURE_Password; 
	...
	java.sql.Connection conn_tDBConnection_5 = null;
			...
			globalMap.put("driverClass_tDBConnection_5", driverClass_tDBConnection_5);
	    		...
	    		log.debug("tDBConnection_5 - Driver ClassName: "+driverClass_tDBConnection_5+".");
			
	    		log.debug("tDBConnection_5 - Connection attempt to '" + url_tDBConnection_5 + "' with the username '" + dbUser_tDBConnection_5 + "'.");
			...
			conn_tDBConnection_5 = java.sql.DriverManager.getConnection(url_tDBConnection_5,dbUser_tDBConnection_5,dbPwd_tDBConnection_5);
	    		log.debug("tDBConnection_5 - Connection to '" + url_tDBConnection_5 + "' has succeeded.");
			

		globalMap.put("conn_tDBConnection_5", conn_tDBConnection_5);
	if (null != conn_tDBConnection_5) {
		
			log.debug("tDBConnection_5 - Connection is set auto commit to 'false'.");
			conn_tDBConnection_5.setAutoCommit(false);
	}

	globalMap.put("dbschema_tDBConnection_5", "");

	globalMap.put("db_tDBConnection_5",  context.PORTAIL_FOURNISSEUR_AZURE_Database);
	
	globalMap.put("shareIdentitySetting_tDBConnection_5",  true);
 ...
 */
	...
	currentComponent="tDBConnection_5";
                ...
                if(log.isDebugEnabled())
            log.debug("tDBConnection_5 - "  + ("Done.") );
                ...
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("CONNECTION" + " = " + "tDBConnection_5");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("FIELD_OPTIONS" + " = " + "[{UPDATE_KEY="+("true")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODE_INTERNE_ARTICLE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODESITE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("EAN")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("DATE_DEBUT")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("DATE_FIN")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODEENSEIGNE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODE_ARTICLE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("QTE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CA_TTC")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CA_HT")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("DateLastUpdateWebJob")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
String dbUser_tDBOutput_2 = null;
	dbschema_tDBOutput_2 = (String)globalMap.get("dbschema_tDBConnection_5");
	
	conn_tDBOutput_2 = (java.sql.Connection)globalMap.get("conn_tDBConnection_5");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
    ...
    java.sql.PreparedStatement pstmtUpdate_tDBOutput_2 = null;
        String insert_tDBOutput_2 = "INSERT INTO [" + tableName_tDBOutput_2 + "] ([CODE_INTERNE_ARTICLE],[CODESITE],[EAN],[DATE_DEBUT],[DATE_FIN],[CODEENSEIGNE],[CODE_ARTICLE],[QTE],[CA_TTC],[CA_HT],[DateLastUpdateWebJob]) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
        pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement(insert_tDBOutput_2);
        resourceMap.put("pstmt_tDBOutput_2", pstmt_tDBOutput_2);

 	boolean isShareIdentity_tDBOutput_2 = globalMap.get("shareIdentitySetting_tDBConnection_5") != null && (Boolean)globalMap.get("shareIdentitySetting_tDBConnection_5") == true;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("CODE_INTERNE_ARTICLE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("CODESITE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("EAN")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("DATE_DEBUT")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("DATE_FIN")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("CODEENSEIGNE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("CODE_ARTICLE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("QTE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("CA_TTC")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("CA_HT")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("DateLastUpdateWebJob")+"}]");
                        log4jParamters_tUniqRow_1.append(" | ");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT      CODE_INTERNE_ARTICLE,      CODESITE,  	EAN,       DATE_DEBUT,   	DATE_FIN,       CODEENSEIGNE,   	CODE_ARTICLE,   	QTE,   	CA_TTC,      CA_HT,  	DATELASTUPDATEWEBJOB    FROM ODS_VENTE_HEBDO  \"");
                        log4jParamters_tDBInput_3.append(" | ");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_INTERNE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODESITE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EAN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_DEBUT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_FIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODEENSEIGNE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("QTE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_TTC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_HT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DateLastUpdateWebJob")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
...
+"CLE, \n	QTE, \n	CA_TTC,\n    CA_HT,\n	DATELASTUPDATEWEBJOB  \nFROM ODS_VENTE_HEBDO\n";
		    ...
		    while (rs_tDBInput_3.next()) {
		        nb_line_tDBInput_3++;
					...
					if(rs_tDBInput_3.getObject(1) != null) {
						row2.CODE_INTERNE_ARTICLE = rs_tDBInput_3.getLong(1);
					} else {
					...
					if(rs_tDBInput_3.getObject(2) != null) {
						row2.CODESITE = rs_tDBInput_3.getLong(2);
					} else {
					...
					if(rs_tDBInput_3.getObject(3) != null) {
						row2.EAN = rs_tDBInput_3.getLong(3);
					} else {
        	...
        	row2.DATE_DEBUT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row2.DATE_FIN = null;
							} else {
	                         		
        	row2.DATE_FIN = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, false);
		                    }
					...
					if(rs_tDBInput_3.getObject(6) != null) {
						row2.CODEENSEIGNE = rs_tDBInput_3.getLong(6);
					} else {
					...
					if(rs_tDBInput_3.getObject(7) != null) {
						row2.CODE_ARTICLE = rs_tDBInput_3.getLong(7);
					} else {
					...
					if(rs_tDBInput_3.getObject(8) != null) {
						row2.QTE = rs_tDBInput_3.getBigDecimal(8);
					} else {
					...
					if(rs_tDBInput_3.getObject(9) != null) {
						row2.CA_TTC = rs_tDBInput_3.getBigDecimal(9);
					} else {
					...
					if(rs_tDBInput_3.getObject(10) != null) {
						row2.CA_HT = rs_tDBInput_3.getBigDecimal(10);
					} else {
			...
			row2.DateLastUpdateWebJob = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 11);
		                    }
 ...
 */
	...
	currentComponent="tMap_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_3","ORACLE_ODS","tOracleInput","tMap_2","tMap_2","tMap"
...
log.debug("tMap_2 - Outputting the record " + count_OUT_AZURE_tMap_2 + " of the output table 'OUT_AZURE'.");
...
if(OUT_AZURE.DATE_FIN == null){
	...
	row8 = new row8Struct();
}row8.CODE_INTERNE_ARTICLE = OUT_AZURE.CODE_INTERNE_ARTICLE;			row8.CODESITE = OUT_AZURE.CODESITE;			row8.EAN = OUT_AZURE.EAN;			row8.DATE_DEBUT = OUT_AZURE.DATE_DEBUT;			row8.DATE_FIN = OUT_AZURE.DATE_FIN;			row8.CODEENSEIGNE = OUT_AZURE.CODEENSEIGNE;			row8.CODE_ARTICLE = OUT_AZURE.CODE_ARTICLE;			row8.QTE = OUT_AZURE.QTE;			row8.CA_TTC = OUT_AZURE.CA_TTC;			row8.CA_HT = OUT_AZURE.CA_HT;			row8.DateLastUpdateWebJob = OUT_AZURE.DateLastUpdateWebJob;					
...
if(row8 != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row8","tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_2","PORTAIL_FOURNISSEUR_AZURE","tMSSqlOutput"
...
} else {pstmt_tDBOutput_2.setLong(1, row8.CODE_INTERNE_ARTICLE);
}

                    if(row8.CODESITE == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(2, row8.CODESITE);
}

                    if(row8.EAN == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(3, row8.EAN);
}

                    if(row8.DATE_DEBUT == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, row8.DATE_DEBUT);
}

                    if(row8.DATE_FIN == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, row8.DATE_FIN);
}

                    if(row8.CODEENSEIGNE == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(6, row8.CODEENSEIGNE);
}

                    if(row8.CODE_ARTICLE == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(7, row8.CODE_ARTICLE);
}
...
pstmt_tDBOutput_2.setTimestamp(11, new java.sql.Timestamp(row8.DateLastUpdateWebJob.getTime()));
} else {
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'OUT_AZURE': " + count_OUT_AZURE_tMap_2 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_3","ORACLE_ODS","tOracleInput","tMap_2","tMap_2","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row8",2,0,
			 			"tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_2","PORTAIL_FOURNISSEUR_AZURE","tMSSqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBCommit_1{
                    ...
                    log4jParamters_tDBCommit_1.append("Parameters:");
                            log4jParamters_tDBCommit_1.append("CONNECTION" + " = " + "tDBConnection_5");
 ...
 */
	...
	java.sql.Connection conn_tDBCommit_1 = (java.sql.Connection)globalMap.get("conn_tDBConnection_5");
	if(conn_tDBCommit_1 != null && !conn_tDBCommit_1.isClosed())
	{
	
			
	    		log.debug("tDBCommit_1 - Connection 'tDBConnection_5' starting to commit.");
			
			conn_tDBCommit_1.commit();
			
	    		log.debug("tDBCommit_1 - Connection 'tDBConnection_5' commit has succeeded.");
...
public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
                ...
                class BytesLimit65535_tDBRow_1{
                    ...
                    log4jParamters_tDBRow_1.append("Parameters:");
                        ...
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("CONNECTION" + " = " + "tDBConnection_5");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("IDENTITY_INSERT" + " = " + "false");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("QUERY" + " = " + "\"MERGE VenteHebdo AS T  USING VenteHebdoTT As S  ON S.CODESITE = T.CODESITE and S.CODE_INTERNE_ARTICLE = T.CODE_INTERNE_ARTICLE and S.DATE_DEBUT = T.DATE_DEBUT and S.DATE_FIN = T.DATE_FIN AND S.EAN = T.EAN  WHEN NOT MATCHED THEN      INSERT (CODE_INTERNE_ARTICLE,CODESITE,EAN,DATE_DEBUT,DATE_FIN,CODEENSEIGNE,CODE_ARTICLE, QTE,CA_TTC,CA_HT,DateLastUpdateWebJob)       VALUES (S.CODE_INTERNE_ARTICLE,S.CODESITE,S.EAN,S.DATE_DEBUT,S.DATE_FIN,S.CODEENSEIGNE,S.CODE_ARTICLE, S.QTE,S.CA_TTC,S.CA_HT,SYSDATETIME())  WHEN MATCHED THEN UPDATE SET      T.QTE = S.QTE, T.CODEENSEIGNE = S.CODEENSEIGNE, T.CA_TTC= S.CA_TTC,      T.CA_HT	= S.CA_HT, T.CODE_ARTICLE= S.CODE_ARTICLE,   	DateLastUpdateWebJob= SYSDATETIME();\"");
                        log4jParamters_tDBRow_1.append(" | ");
	...
	boolean whetherReject_tDBRow_1 = false;
				conn_tDBRow_1 = (java.sql.Connection)globalMap.get("conn_tDBConnection_5");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBCommit_2{
                    ...
                    log4jParamters_tDBCommit_2.append("Parameters:");
                            log4jParamters_tDBCommit_2.append("CONNECTION" + " = " + "tDBConnection_5");
 ...
 */
	...
	java.sql.Connection conn_tDBCommit_2 = (java.sql.Connection)globalMap.get("conn_tDBConnection_5");
	if(conn_tDBCommit_2 != null && !conn_tDBCommit_2.isClosed())
	{
	
			
	    		log.debug("tDBCommit_2 - Connection 'tDBConnection_5' starting to commit.");
			
			conn_tDBCommit_2.commit();
			
	    		log.debug("tDBCommit_2 - Connection 'tDBConnection_5' commit has succeeded.");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","OK","", "");
                if(log.isInfoEnabled())
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "context.PATH_VENTE_HEBDO+\"/FRNS_VENTE_HEBDO_\"+((String)globalMap.get(\"CurrentDate\"))+\".csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.PATH_VENTE_HEBDO+"/FRNS_VENTE_HEBDO_"+((String)globalMap.get("CurrentDate"))+".csv")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_HEBDO_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	row6.FOUCFIN = next_tHashInput_2.FOUCFIN;
	row6.LIBFRS = next_tHashInput_2.LIBFRS;
	row6.FOUCNUF = next_tHashInput_2.FOUCNUF;
 ...
 */
	...
	currentComponent="tMap_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row6","tHashInput_2","FOURNISSEEUR","tHashInput","tMap_3","tMap_3","tMap"
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.FOUCFIN = '" + row7HashKey.FOUCFIN + "'");
								} // G 071
...
OUTFRN = OUTFRN_tmp;
log.debug("tMap_3 - Outputting the record " + count_OUTFRN_tMap_3 + " of the output table 'OUTFRN'.");
...
if(OUTFRN != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"OUTFRN","tMap_3","tMap_3","tMap","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_JOB_VENTE_HEBDO_" + pid +"_tHashOutput_1");
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				log.debug("tFileOutputDelimited_1 - Written records count: " + nb_line_tFileOutputDelimited_1 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"OUTFRN",2,0,
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSendMail_1{
                    ...
                    log4jParamters_tSendMail_1.append("Parameters:");
                        ...
                        log4jParamters_tSendMail_1.append(" | ");
                            log4jParamters_tSendMail_1.append("SUBJECT" + " = " + "\"FRNS VENTE HEBDO\"");
                        log4jParamters_tSendMail_1.append(" | ");
                            log4jParamters_tSendMail_1.append("MESSAGE" + " = " + "\"Hello,  Merci de trouver ci-joint les fournisseurs de l'alimentation des ventes Hebdo.  Cordialement\"");
                        log4jParamters_tSendMail_1.append(" | ");
 ...
 */
    ...
    String subject_tSendMail_1 = ("FRNS VENTE HEBDO");
		...
		int tos_count_tAdvancedHash_row5 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// source node:tHashInput_1 - inputs:(after_tDBInput_1) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_HEBDO_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_1.hasNext()) {
	...
	row5.LIBFRS = next_tHashInput_1.LIBFRS;
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tHashInput_1","FOURNISSEUR","tHashInput","tAdvancedHash_row5","tAdvancedHash_row5","tAdvancedHash"
...
tHash_Lookup_row5.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row5",2,0,
			 			"tHashInput_1","FOURNISSEUR","tHashInput","tAdvancedHash_row5","tAdvancedHash_row5","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		int tos_count_tAdvancedHash_row7 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// source node:tHashInput_3 - inputs:(after_tHashInput_2) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_HEBDO_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row7","tHashInput_3","COUNTFRN","tHashInput","tAdvancedHash_row7","tAdvancedHash_row7","tAdvancedHash"
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_JOB_VENTE_HEBDO_" + pid +"_tHashOutput_2");
...
tHash_Lookup_row7.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row7",2,0,
			 			"tHashInput_3","COUNTFRN","tHashInput","tAdvancedHash_row7","tAdvancedHash_row7","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.mdp_gold)).substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
        ...
        String url_tDBConnection_1 = "jdbc:oracle:thin:@" + context.host_gold + ":" + context.port_gold + ":" + context.sid_gold;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_2";
		...
		int tos_count_tDBConnection_2 = 0;
                ...
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("HOST" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Server");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PORT" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Port");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("SCHEMA_DB" + " = " + "\"\"");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("DBNAME" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Database");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("USER" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Login");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.PORTAIL_FOURNISSEUR_AZURE_Password)).substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PROPERTIES" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_AdditionalParams");
                        log4jParamters_tDBConnection_2.append(" | ");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("SHARE_IDENTITY_SETTING" + " = " + "true");
                        log4jParamters_tDBConnection_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBConnection_2", "MSS AZURE", "tMSSqlConnection");
				talendJobLogProcess(globalMap);
			}
			...
			String url_tDBConnection_2 = "jdbc:jtds:sqlserver://" + context.PORTAIL_FOURNISSEUR_AZURE_Server ;
		String port_tDBConnection_2 = context.PORTAIL_FOURNISSEUR_AZURE_Port;
		String dbname_tDBConnection_2 = context.PORTAIL_FOURNISSEUR_AZURE_Database ;
    	if (!"".equals(port_tDBConnection_2)) {
    		url_tDBConnection_2 += ":" + context.PORTAIL_FOURNISSEUR_AZURE_Port;
    	}
    	if (!"".equals(dbname_tDBConnection_2)) {
    		
				url_tDBConnection_2 += "//" + context.PORTAIL_FOURNISSEUR_AZURE_Database; 
    	}

		url_tDBConnection_2 += ";appName=" + projectName + ";" + context.PORTAIL_FOURNISSEUR_AZURE_AdditionalParams;  
	String dbUser_tDBConnection_2 = context.PORTAIL_FOURNISSEUR_AZURE_Login;
	
	
		
	final String decryptedPassword_tDBConnection_2 = context.PORTAIL_FOURNISSEUR_AZURE_Password; 
	...
	globalMap.put("db_tDBConnection_2",  context.PORTAIL_FOURNISSEUR_AZURE_Database);
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBClose_2{
                    ...
                    log4jParamters_tDBClose_2.append("Parameters:");
                            log4jParamters_tDBClose_2.append("CONNECTION" + " = " + "tDBConnection_5");
 ...
 */
	...
	java.sql.Connection conn_tDBClose_2 = (java.sql.Connection)globalMap.get("conn_tDBConnection_5");
	if(conn_tDBClose_2 != null && !conn_tDBClose_2.isClosed())
	{
                if(log.isDebugEnabled())
            log.debug("tDBClose_2 - "  + ("Closing the connection ")  + ("conn_tDBConnection_5")  + (" to the database.") );
        conn_tDBClose_2.close();
                if(log.isDebugEnabled())
            log.debug("tDBClose_2 - "  + ("Connection ")  + ("conn_tDBConnection_5")  + (" to the database has closed.") );
	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBClose_3";
		...
		int tos_count_tDBClose_3 = 0;
                ...
                class BytesLimit65535_tDBClose_3{
                    ...
                    log4jParamters_tDBClose_3.append("Parameters:");
                        ...
                        log4jParamters_tDBClose_3.append(" | ");
                            log4jParamters_tDBClose_3.append("UNIFIED_COMPONENTS" + " = " + "tOracleClose");
                        log4jParamters_tDBClose_3.append(" | ");
                if(log.isDebugEnabled())
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBClose_3", "tDBClose_3", "tOracleClose");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	if(conn_tDBClose_3 != null && !conn_tDBClose_3.isClosed())
	{
	    		...
	    		log.debug("tDBClose_3 - Closing the connection 'tDBConnection_3' to the database.");
			...
			if("com.mysql.cj.jdbc.Driver".equals((String)globalMap.get("driverClass_tDBConnection_3"))
	    		...
	    		log.debug("tDBClose_3 - Connection 'tDBConnection_3' to the database closed.");
 ...
 */
    ...
    public static void main(String[] args){
        final JOB_VENTE_HEBDO JOB_VENTE_HEBDOClass = new JOB_VENTE_HEBDO();

        int exitCode = JOB_VENTE_HEBDOClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'JOB_VENTE_HEBDO' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'JOB_VENTE_HEBDO' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = JOB_VENTE_HEBDO.class.getClassLoader().getResourceAsStream("bi_team_projects/job_vente_hebdo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = JOB_VENTE_HEBDO.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("PATH_VENTE_HEBDO")) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JOB_VENTE_HEBDO");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     536540 characters generated by Talend Cloud Data Management Platform 
 *     on the 21 juillet 2022 à 16:19:48 WEST
 ************************************************************************************************/