		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row3", "tDBInput_1", "PORTAIL_FOURNISSEUR_AZURE", "tMSSqlInput", "tHashOutput_1",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tDBInput_1", "PORTAIL_FOURNISSEUR_AZURE", "tMSSqlInput", "tHashOutput_1", "Fournisseur",
						"tHashOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// clear the temporary values in the globalMap
				...
				while ((((globalMap.get("tDBInput_4_SUBPROCESS_STATE") == null) ? true
						: ((Integer) globalMap.get("tDBInput_4_SUBPROCESS_STATE") == 0))
						|| ((globalMap.get("tDBInput_5_SUBPROCESS_STATE") == null) ? true
								: ((Integer) globalMap.get("tDBInput_5_SUBPROCESS_STATE") == 0))
						|| ((globalMap.get("tDBInput_6_SUBPROCESS_STATE") == null) ? true
								: ((Integer) globalMap.get("tDBInput_6_SUBPROCESS_STATE") == 0))
						|| ((globalMap.get("tDBInput_7_SUBPROCESS_STATE") == null) ? true
								: ((Integer) globalMap.get("tDBInput_7_SUBPROCESS_STATE") == 0))
						|| false)) {
					Thread.sleep(100);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (CODE_ENSEIGNE,CODE_INTERNE_ARTICLE,CODE_ARTICLE,CODE_SITE,LIB_ARTICLE,EAN,VALO_STOCK,QTE_STOCK,DATE_STOCK,LAST_MAJ_DATE,FOUCIN) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_4", "ORACLE_GOLD", "tOracleInput", "tDBOutput_1", "tDBOutput_1",
								"tOracleOutput"
						...
						if (row1.DATE_STOCK != null) {
							pstmt_tDBOutput_1.setObject(9, new java.sql.Timestamp(row1.DATE_STOCK.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row1.LAST_MAJ_DATE != null) {
							pstmt_tDBOutput_1.setObject(10, new java.sql.Timestamp(row1.LAST_MAJ_DATE.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row1.FOUCIN == null) {
							...
							pstmt_tDBOutput_1.setInt(11, row1.FOUCIN);
						}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_4", "ORACLE_GOLD", "tOracleInput", "tDBOutput_1", "tDBOutput_1", "tOracleOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row7", "tDBInput_2", "tDBInput_2", "tOracleInput", "tMap_2", "tMap_2", "tMap"
...
// # Output table : 'fouci'
									...
									fouci = fouci_tmp;
									log.debug("tMap_2 - Outputting the record " + count_fouci_tMap_2
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "out1", "tMap_2", "tMap_2", "tMap", "tDBOutput_6", "Oracle_ODS",
										"tOracleOutput"
								...
								if (out1.DATE_STOCK != null) {
									pstmt_tDBOutput_6.setObject(9, new java.sql.Timestamp(out1.DATE_STOCK.getTime()),
											java.sql.Types.DATE);
								} else {
								...
								if (out1.LAST_MAJ_DATE != null) {
									pstmt_tDBOutput_6.setObject(10,
								...
								try {
									...
									if (log.isDebugEnabled())
										log.debug("tDBOutput_6 - " + ("Inserting") + (" the record ")
												+ (nb_line_tDBOutput_6) + ("."));
...
// Start of branch "fouci"
							if (fouci != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "fouci", "tMap_2", "tMap_2", "tMap", "tAggregateRow_1_AGGOUT",
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row7", 2, 0,
						"tDBInput_2", "tDBInput_2", "tOracleInput", "tMap_2", "tMap_2", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "out1", 2, 0, "tMap_2",
						"tMap_2", "tMap", "tDBOutput_6", "Oracle_ODS", "tOracleOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "fouci", 2, 0, "tMap_2",
						"tMap_2", "tMap", "tAggregateRow_1_AGGOUT", "tAggregateRow_1_AGGOUT", "tAggregateOut",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				synchronized (org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
					...
					if (mf_tHashOutput_2.getResourceMap().get(hashKey_tHashOutput_2) == null) {
						mf_tHashOutput_2.getResourceMap().put(hashKey_tHashOutput_2,
								new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row12Struct>(
										org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
							...
							, "row12", "tAggregateRow_1_AGGIN", "tAggregateRow_1_AGGIN", "tAggregateIn",
							"tHashOutput_2", "COUNTFRN", "tHashOutput"
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_5 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_5.append(" | ");
							log4jParamters_tDBOutput_5.append("FIELD_OPTIONS" + " = " + "[{UPDATE_KEY=" + ("false")
				...
				try (java.sql.Statement stmtTrunc_tDBOutput_5 = conn_tDBOutput_5.createStatement()) {
					...
					if (log.isDebugEnabled())
						log.debug("tDBOutput_5 - " + ("Truncate") + (" table '") + ("[" + tableName_tDBOutput_5 + "]")
								+ ("' has succeeded."));
...
// # Output table : 'OUT_AZURE'
							...
							log.debug("tMap_1 - Outputting the record " + count_OUT_AZURE_tMap_1
...
// Start of branch "row8"
							if (row8 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row8", "tUniqRow_1", "tUniqRow_1", "tUniqRow", "tDBOutput_5",
								...
								if (row8.DATE_STOCK != null) {
									pstmt_tDBOutput_5.setTimestamp(9,
								...
								if (row8.DateLastUpdateWebJob != null) {
									pstmt_tDBOutput_5.setTimestamp(10,
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row8", 2, 0,
						"tUniqRow_1", "tUniqRow_1", "tUniqRow", "tDBOutput_5", "PORTAIL_FOURNISSEUR_AZURE",
						"tMSSqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBRow_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBRow_2.append(" | ");
							log4jParamters_tDBRow_2.append("QUERY" + " = "
	...
	public void tHashInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(context.PATH_STOCK_HEBDO + "/FRNS_STOCK_HEBDO_"
...
// # Output table : 'copyOfOUTFRN'
						...
						log.debug("tMap_3 - Outputting the record " + count_copyOfOUTFRN_tMap_3
...
// Start of branch "copyOfOUTFRN"
					if (copyOfOUTFRN != null) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "copyOfOUTFRN", "tMap_3", "tMap_3", "tMap", "tFileOutputDelimited_1",
						...
						if (copyOfOUTFRN.FOUCFIN_FOURNISSEUR != null) {
							sb_tFileOutputDelimited_1.append(copyOfOUTFRN.FOUCFIN_FOURNISSEUR);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (copyOfOUTFRN.LIBFRS_FOURNISSEUR != null) {
							sb_tFileOutputDelimited_1.append(copyOfOUTFRN.LIBFRS_FOURNISSEUR);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (copyOfOUTFRN.FOUCNUF_FOURNISSEUR != null) {
							sb_tFileOutputDelimited_1.append(copyOfOUTFRN.FOUCNUF_FOURNISSEUR);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (copyOfOUTFRN.COUNTFRN != null) {
							sb_tFileOutputDelimited_1.append(copyOfOUTFRN.COUNTFRN);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (copyOfOUTFRN.Date_Debut != null) {
							sb_tFileOutputDelimited_1.append(copyOfOUTFRN.Date_Debut);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (copyOfOUTFRN.Date_Fin != null) {
							sb_tFileOutputDelimited_1.append(copyOfOUTFRN.Date_Fin);
						}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "copyOfOUTFRN", 2, 0,
						"tMap_3", "tMap_3", "tMap", "tFileOutputDelimited_1", "tFileOutputDelimited_1",
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row4", "tDBInput_5", "ORACLE_GOLD", "tOracleInput", "tDBOutput_2", "tDBOutput_2",
								"tOracleOutput"
						...
						if (row4.DATE_STOCK != null) {
							pstmt_tDBOutput_2.setObject(9, new java.sql.Timestamp(row4.DATE_STOCK.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row4.LAST_MAJ_DATE != null) {
							pstmt_tDBOutput_2.setObject(10, new java.sql.Timestamp(row4.LAST_MAJ_DATE.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row4.FOUCIN == null) {
							...
							pstmt_tDBOutput_2.setInt(11, row4.FOUCIN);
						}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tDBInput_5", "ORACLE_GOLD", "tOracleInput", "tDBOutput_2", "tDBOutput_2", "tOracleOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_6.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row6", "tDBInput_6", "ORACLE_GOLD", "tOracleInput", "tDBOutput_3", "tDBOutput_3",
								"tOracleOutput"
						...
						if (row6.DATE_STOCK != null) {
							pstmt_tDBOutput_3.setObject(9, new java.sql.Timestamp(row6.DATE_STOCK.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row6.LAST_MAJ_DATE != null) {
							pstmt_tDBOutput_3.setObject(10, new java.sql.Timestamp(row6.LAST_MAJ_DATE.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row6.FOUCIN == null) {
							...
							pstmt_tDBOutput_3.setInt(11, row6.FOUCIN);
						}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row6", 2, 0,
						"tDBInput_6", "ORACLE_GOLD", "tOracleInput", "tDBOutput_3", "tDBOutput_3", "tOracleOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_7.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row5", "tDBInput_7", "ORACLE_GOLD", "tOracleInput", "tDBOutput_4", "tDBOutput_4",
								"tOracleOutput"
						...
						if (row5.DATE_STOCK != null) {
							pstmt_tDBOutput_4.setObject(9, new java.sql.Timestamp(row5.DATE_STOCK.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row5.LAST_MAJ_DATE != null) {
							pstmt_tDBOutput_4.setObject(10, new java.sql.Timestamp(row5.LAST_MAJ_DATE.getTime()),
									java.sql.Types.DATE);
						} else {
						...
						if (row5.FOUCIN == null) {
							...
							pstmt_tDBOutput_4.setInt(11, row5.FOUCIN);
						}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row5", 2, 0,
						"tDBInput_7", "ORACLE_GOLD", "tOracleInput", "tDBOutput_4", "tDBOutput_4", "tOracleOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tHashInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tHashInput_1 - inputs:(after_tDBInput_2) outputs:(row11,row11) |
				// target node:tAdvancedHash_row11 - inputs:(row11) outputs:()
				// linked node: tMap_2 - inputs:(row7,row11) outputs:(out1,fouci)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_row11 = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.ALL_MATCHES;
				...
				while (iterator_tHashInput_1.hasNext()) {
					...
					if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
							...
							, "row11", "tHashInput_1", "FOURNISSEUR", "tHashInput", "tAdvancedHash_row11",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row11", 2, 0,
						"tHashInput_1", "FOURNISSEUR", "tHashInput", "tAdvancedHash_row11", "tAdvancedHash_row11",
	...
	public void tHashInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tHashInput_3 - inputs:(after_tHashInput_2) outputs:(row10,row10)
				...
				org.talend.designer.components.hashfile.common.MapHashFile mf_tHashInput_3 = org.talend.designer.components.hashfile.common.MapHashFile
						.getMapHashFile();
				org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row12Struct> tHashFile_tHashInput_3 = mf_tHashInput_3
				...
				while (iterator_tHashInput_3.hasNext()) {
					...
					if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
							...
							, "row10", "tHashInput_3", "COUNTFRN", "tHashInput", "tAdvancedHash_row10",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row10", 2, 0,
						"tHashInput_3", "COUNTFRN", "tHashInput", "tAdvancedHash_row10", "tAdvancedHash_row10",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
...
/************************************************************************************************
 * 831292 characters generated by Talend Cloud Data Management Platform on the
 * 11 août 2022 à 19:21:09 WEST
 ************************************************************************************************/