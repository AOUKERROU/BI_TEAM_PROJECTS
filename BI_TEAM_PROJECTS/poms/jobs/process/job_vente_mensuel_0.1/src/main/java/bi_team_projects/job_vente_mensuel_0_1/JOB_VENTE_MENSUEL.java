...
public class JOB_VENTE_MENSUEL implements TalendJob {
	static {System.setProperty("TalendJob.log", "JOB_VENTE_MENSUEL.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(JOB_VENTE_MENSUEL.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Y9JC0IgJEeypj6gbNStL7g", "0.1");
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_3";
                ...
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("HOST" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Server");
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PORT" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Port");
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("SCHEMA_DB" + " = " + "\"\"");
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("DBNAME" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Database");
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("USER" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_Login");
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.PORTAIL_FOURNISSEUR_AZURE_Password)).substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PROPERTIES" + " = " + "context.PORTAIL_FOURNISSEUR_AZURE_AdditionalParams");
                        log4jParamters_tDBConnection_3.append(" | ");
		...
		url_tDBConnection_3 += ";appName=" + projectName + ";" + context.PORTAIL_FOURNISSEUR_AZURE_AdditionalParams;  
...
public void tDBConnection_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_4";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_4{
                    ...
                    log4jParamters_tDBConnection_4.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_4.append(" | ");
                            log4jParamters_tDBConnection_4.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.mdp_ods)).substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_4.append(" | ");
        ...
        String url_tDBConnection_4 = "jdbc:oracle:thin:@" + context.host_ods + ":" + context.port_ods + ":" + context.sid_ods;
 ...
 */
	...
	{
                if(log.isDebugEnabled())
            log.debug("tDBClose_1 - "  + ("Closing the connection ")  + ("conn_tDBConnection_3")  + (" to the database.") );
        conn_tDBClose_1.close();
                if(log.isDebugEnabled())
            log.debug("tDBClose_1 - "  + ("Connection ")  + ("conn_tDBConnection_3")  + (" to the database has closed.") );
	}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    ...
    static byte[] commonByteArray_BI_TEAM_PROJECTS_JOB_VENTE_MENSUEL = new byte[0];
				...
				public Boolean FOULIBIsNullable(){
				    return true;
				}
				public Boolean FOULIBIsKey(){
				    return false;
				}
				public Integer FOULIBLength(){
				    return null;
				}
				public Integer FOULIBPrecision(){
				    return null;
				}
				public String FOULIBDefault(){
				
					return null;
				
				}
				public String FOULIBComment(){
				
				    return "";
				
				}
				public String FOULIBPattern(){
				
					return "";
				
				}
				public String FOULIBOriginalDbColumnName(){
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    static byte[] commonByteArray_BI_TEAM_PROJECTS_JOB_VENTE_MENSUEL = new byte[0];
				...
				public Boolean QTEIsNullable(){
				    return true;
				}
				public Boolean QTEIsKey(){
				    return false;
				}
				public Integer QTELength(){
				    return 16;
				}
				public Integer QTEPrecision(){
				    return 4;
				}
				public String QTEDefault(){
				
					return null;
				
				}
				public String QTEComment(){
				
				    return "";
				
				}
				public String QTEPattern(){
				
					return "";
				
				}
				public String QTEOriginalDbColumnName(){
				...
				public Boolean CA_TTCIsNullable(){
				    return true;
				}
				public Boolean CA_TTCIsKey(){
				    return false;
				}
				public Integer CA_TTCLength(){
				    return 16;
				}
				public Integer CA_TTCPrecision(){
				    return 4;
				}
				public String CA_TTCDefault(){
				
					return null;
				
				}
				public String CA_TTCComment(){
				
				    return "";
				
				}
				public String CA_TTCPattern(){
				
					return "";
				
				}
				public String CA_TTCOriginalDbColumnName(){
				...
				public Boolean CA_HTIsNullable(){
				    return true;
				}
				public Boolean CA_HTIsKey(){
				    return false;
				}
				public Integer CA_HTLength(){
				    return 16;
				}
				public Integer CA_HTPrecision(){
				    return 4;
				}
				public String CA_HTDefault(){
				
					return null;
				
				}
				public String CA_HTComment(){
				
				    return "";
				
				}
				public String CA_HTPattern(){
				
					return "";
				
				}
				public String CA_HTOriginalDbColumnName(){
...
public static class fouciStruct implements routines.system.IPersistableRow<fouciStruct> {
    ...
    static byte[] commonByteArray_BI_TEAM_PROJECTS_JOB_VENTE_MENSUEL = new byte[0];
			    ...
			    public String COUNTFRN;

				public String getCOUNTFRN () {
					return this.COUNTFRN;
				}
    ...
    String tableName_tDBOutput_1 = null;
        ...
        if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
            ...
            log.debug("tDBOutput_1 - "  + ("Truncate")  + (" table '")  + (tableName_tDBOutput_1)  + ("' has succeeded.") );
                ...
                String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1 + " (EAN,CODE_INTERNE_ARTICLE,CODESITE,DATE_DEBUT,DATE_FIN,CODEENSEIGNE,CODE_ARTICLE,QTE,CA_TTC,CA_HT,DateLastUpdateWebJob) VALUES (?,?,?,?,?,?,?,?,?,?,?)";    
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("EAN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_INTERNE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODESITE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_DEBUT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_FIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODEENSEIGNE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("QTE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_TTC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_HT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DateLastUpdateWebJob")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("FOUCIN")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
...
} else {pstmt_tDBOutput_1.setLong(1, out1.EAN);
}
...
} else {pstmt_tDBOutput_1.setLong(3, out1.CODESITE);
}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT      CODE_INTERNE_ARTICLE,      CODESITE,  	EAN,       DATE_DEBUT,   	DATE_FIN,       CODEENSEIGNE,   	CODE_ARTICLE,   	QTE,   	CA_TTC,      CA_HT,  	DATELASTUPDATEWEBJOB    FROM ODS_VENTE_MENSUEL  \"");
                        log4jParamters_tDBInput_2.append(" | ");
 ...
 */
	...
	if(true){	
		TDieException e_tDie_1 = new TDieException();
			...
			if(enableLogStash) {
				talendJobLog.addJobExceptionMessage(currentComponent, cLabel, "ERROR", e_tDie_1);
				talendJobLogProcess(globalMap);
			}
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "context.PATH_VENTE_MENSUEL+\"/FRNS_VENTE_MENSUEL_\"+((String)globalMap.get(\"CurrentDate\"))+\".csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.PATH_VENTE_MENSUEL+"/FRNS_VENTE_MENSUEL_"+((String)globalMap.get("CurrentDate"))+".csv")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_MENSUEL_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tMap_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row6","tHashInput_1","FOURNISSEEUR","tHashInput","tMap_3","tMap_2","tMap"
...
if(OUTFRN != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"OUTFRN","tMap_3","tMap_2","tMap","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_JOB_VENTE_MENSUEL_" + pid +"_tHashOutput_1");
...
// ###############################      
				log.debug("tMap_3 - Written records count in the table 'OUTFRN': " + count_OUTFRN_tMap_3 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row6",2,0,
			 			"tHashInput_1","FOURNISSEEUR","tHashInput","tMap_3","tMap_2","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				log.debug("tFileOutputDelimited_1 - Written records count: " + nb_line_tFileOutputDelimited_1 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"OUTFRN",2,0,
			 			"tMap_3","tMap_2","tMap","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSendMail_1{
                    ...
                    log4jParamters_tSendMail_1.append("Parameters:");
                        ...
                        log4jParamters_tSendMail_1.append(" | ");
                            log4jParamters_tSendMail_1.append("MESSAGE" + " = " + "\"Hello,  Merci de trouver ci-joint les fournisseurs de l'alimentation des ventes Mensuel.  Cordialement\"");
                        log4jParamters_tSendMail_1.append(" | ");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_MENSUEL_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	row5.FOUCIN = next_tHashInput_2.FOUCFIN;
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_JOB_VENTE_MENSUEL_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_JOB_VENTE_MENSUEL_" + pid +"_tHashOutput_2");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = JOB_VENTE_MENSUEL.class.getClassLoader().getResourceAsStream("bi_team_projects/job_vente_mensuel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = JOB_VENTE_MENSUEL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("PATH_VENTE_MENSUEL")) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JOB_VENTE_MENSUEL");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     606386 characters generated by Talend Cloud Data Management Platform 
 *     on the 12 août 2022 à 11:50:52 WEST
 ************************************************************************************************/