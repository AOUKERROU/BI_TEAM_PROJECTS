				...
				class Util_tLogRow_1 {
					...
					public String print(String[] row, int nbLine) {
						...
						for (int i = 0; i < titleWidth - "Nb_Rejets".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[15]);
						for (int i = 0; row[15] == null && i < dataWidth - 3
								|| row[15] != null && i < dataWidth - row[15].length() + 1; i++)
							sb.append(" ");
						sb.append("|" + "\n");
...
///////////////////////		
						...
						if (Log_Out.Nb_Insert != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(Log_Out.Nb_Insert));
						...
						if (Log_Out.Nb_Update != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(Log_Out.Nb_Update));
						...
						if (Log_Out.Nb_Delete != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(Log_Out.Nb_Delete));
						...
						if (Log_Out.Nb_Rejets != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(Log_Out.Nb_Rejets));
						...
						if (Log_Out.Nb_Insert != null) { //
							row_tLogRow_1[12] = String.valueOf(Log_Out.Nb_Insert);

						} //

						if (Log_Out.Nb_Update != null) { //
							row_tLogRow_1[13] = String.valueOf(Log_Out.Nb_Update);

						} //

						if (Log_Out.Nb_Delete != null) { //
							row_tLogRow_1[14] = String.valueOf(Log_Out.Nb_Delete);

						} //

						if (Log_Out.Nb_Rejets != null) { //
							row_tLogRow_1[15] = String.valueOf(Log_Out.Nb_Rejets);
...
/************************************************************************************************
 * 710901 characters generated by Talend Cloud Data Management Platform on the
 * 28 juillet 2022 à 15:14:24 WEST
 ************************************************************************************************/