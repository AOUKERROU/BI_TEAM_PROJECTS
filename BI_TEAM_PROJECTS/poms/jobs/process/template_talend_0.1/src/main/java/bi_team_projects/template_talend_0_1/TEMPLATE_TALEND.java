...
public class TEMPLATE_TALEND implements TalendJob {
	static {System.setProperty("TalendJob.log", "TEMPLATE_TALEND.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(TEMPLATE_TALEND.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(REJET != null){
					...
					this.setProperty("REJET", REJET.toString());
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_0-AqwAmpEe2IX-E-61NGPg", "0.1");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tFlowMeter_15_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSetGlobalVar_2{
                    ...
                    log4jParamters_tSetGlobalVar_2.append("Parameters:");
                            log4jParamters_tSetGlobalVar_2.append("VARIABLES" + " = " + "[{VALUE="+("TalendDate.formatDate(\"yyyy-MM-dd_HH-mm-ss\",TalendDate.getCurrentDate())")+", KEY="+("\"CurrentDate\"")+"}, {VALUE="+("\"Integration de Données\"")+", KEY="+("\"TaskType\"")+"}, {VALUE="+("\"VenteHebdo\"")+", KEY="+("\"TaskName\"")+"}, {VALUE="+("\"Integration des Ventes Hebdo dans le Protail Fournisseur\"")+", KEY="+("\"TaskDetail\"")+"}]");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"Select FOUCFIN,LIBFRS, FOUCNUF  from Fournisseur  where ISABONNE = 1  order by FOUCFIN\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("FOUCFIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LIBFRS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("FOUCNUF")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
 ...
 */
	...
	currentComponent="tHashOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_3","PORTAIL_FOURNISSEUR_AZURE","tMSSqlInput","tHashOutput_1","FOURNISSEUR","tHashOutput"
...
globalMap.put("tHashOutput_1_NB_LINE", nb_line_tHashOutput_1);
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_3","PORTAIL_FOURNISSEUR_AZURE","tMSSqlInput","tHashOutput_1","FOURNISSEUR","tHashOutput","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	currentComponent="tMap_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Nbr_lignes_gold","tDBInput_1","ORACLE_GOLD","tOracleInput","tMap_1","tMap_1","tMap"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("Nbr_lignes_gold - " + (Nbr_lignes_gold==null? "": Nbr_lignes_gold.toLogString()));
    			}
...
out1_tmp.DATE_DEBUT = TalendDate.parseDate("yyyy-MM-dd",Nbr_lignes_gold.DATE_DEBUT) ;
...
public static class nbr_lignes_portail_frnsStruct implements routines.system.IPersistableRow<nbr_lignes_portail_frnsStruct> {
    final static byte[] commonByteArrayLock_BI_TEAM_PROJECTS_TEMPLATE_TALEND = new byte[0];
    static byte[] commonByteArray_BI_TEAM_PROJECTS_TEMPLATE_TALEND = new byte[0];
 ...
 */
	...
	currentComponent="tFlowMeter_15";
			...
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"nbr_lignes_portail_frns");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT      CODE_INTERNE_ARTICLE,      CODESITE,  	EAN,       DATE_DEBUT,   	DATE_FIN,       CODEENSEIGNE,   	CODE_ARTICLE,   	QTE,   	CA_TTC,      CA_HT,  	DATELASTUPDATEWEBJOB    FROM ODS_VENTE_HEBDO  \"");
                        log4jParamters_tDBInput_2.append(" | ");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_INTERNE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODESITE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EAN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_DEBUT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_FIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODEENSEIGNE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CODE_ARTICLE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("QTE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_TTC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CA_HT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DateLastUpdateWebJob")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
...
if(OUT_AZURE.DATE_FIN == null){
	...
	new_tUniqRow_1.DATE_FIN = OUT_AZURE.DATE_FIN.toLowerCase();
		...
		keystUniqRow_1.add(new_tUniqRow_1);if(nbr_lignes_portail_frns == null){ 
	
		log.trace("tUniqRow_1 - Writing the unique record " + (nb_uniques_tUniqRow_1+1) + " into nbr_lignes_portail_frns.");
	
	nbr_lignes_portail_frns = new nbr_lignes_portail_frnsStruct();
}nbr_lignes_portail_frns.CODE_INTERNE_ARTICLE = OUT_AZURE.CODE_INTERNE_ARTICLE;			nbr_lignes_portail_frns.CODESITE = OUT_AZURE.CODESITE;			nbr_lignes_portail_frns.EAN = OUT_AZURE.EAN;			nbr_lignes_portail_frns.DATE_DEBUT = OUT_AZURE.DATE_DEBUT;			nbr_lignes_portail_frns.DATE_FIN = OUT_AZURE.DATE_FIN;			nbr_lignes_portail_frns.CODEENSEIGNE = OUT_AZURE.CODEENSEIGNE;			nbr_lignes_portail_frns.CODE_ARTICLE = OUT_AZURE.CODE_ARTICLE;			nbr_lignes_portail_frns.QTE = OUT_AZURE.QTE;			nbr_lignes_portail_frns.CA_TTC = OUT_AZURE.CA_TTC;			nbr_lignes_portail_frns.CA_HT = OUT_AZURE.CA_HT;			nbr_lignes_portail_frns.DateLastUpdateWebJob = OUT_AZURE.DateLastUpdateWebJob;					
...
if(nbr_lignes_portail_frns != null) { 
	...
	currentComponent="tFlowMeter_15";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"nbr_lignes_portail_frns","tUniqRow_1","tUniqRow_1","tUniqRow","tFlowMeter_15","tFlowMeter_15","tFlowMeter"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("nbr_lignes_portail_frns - " + (nbr_lignes_portail_frns==null? "": nbr_lignes_portail_frns.toLogString()));
    			}
 ...
 */
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row10","tFlowMeter_15","tFlowMeter_15","tFlowMeter","tDBOutput_2","PORTAIL_FOURNISSEUR_AZURE","tMSSqlOutput"
...
} else {pstmt_tDBOutput_2.setLong(1, row10.CODE_INTERNE_ARTICLE);
}

                    if(row10.CODESITE == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(2, row10.CODESITE);
}

                    if(row10.EAN == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(3, row10.EAN);
}

                    if(row10.DATE_DEBUT == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, row10.DATE_DEBUT);
}

                    if(row10.DATE_FIN == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, row10.DATE_FIN);
}

                    if(row10.CODEENSEIGNE == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(6, row10.CODEENSEIGNE);
}

                    if(row10.CODE_ARTICLE == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(7, row10.CODE_ARTICLE);
}
...
pstmt_tDBOutput_2.setTimestamp(11, new java.sql.Timestamp(row10.DateLastUpdateWebJob.getTime()));
} else {
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("Nbr_Fournisseur", new Integer(count_tFlowMeter_15), "Nbr_lignes_gold", "", "tFlowMeter_15");

			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"nbr_lignes_portail_frns",2,0,
			 			"tUniqRow_1","tUniqRow_1","tUniqRow","tFlowMeter_15","tFlowMeter_15","tFlowMeter","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row10",2,0,
			 			"tFlowMeter_15","tFlowMeter_15","tFlowMeter","tDBOutput_2","PORTAIL_FOURNISSEUR_AZURE","tMSSqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
                ...
                class BytesLimit65535_tFileOutputDelimited_2{
                    ...
                    log4jParamters_tFileOutputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
                            log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = " + "context.REJET +\"/REJET_\"+((String)globalMap.get(\"CurrentDate\"))+\".csv\"");
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.REJET +"/REJET_"+((String)globalMap.get("CurrentDate"))+".csv")).getAbsolutePath().replace("\\","/");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSetGlobalVar_3{
                    ...
                    log4jParamters_tSetGlobalVar_3.append("Parameters:");
                            log4jParamters_tSetGlobalVar_3.append("VARIABLES" + " = " + "[{VALUE="+("TalendDate.formatDate(\"yyyy-MM-dd_HH-mm-ss\",TalendDate.getCurrentDate())")+", KEY="+("\"CurrentDate2\"")+"}]");
                ...
                class BytesLimit65535_tMap_3{
                    ...
                    log4jParamters_tMap_3.append("Parameters:");
                        ...
                        log4jParamters_tMap_3.append(" | ");
                            log4jParamters_tMap_3.append("TEMPORARY_DATA_DIRECTORY" + " = " + "((Long)globalMap.get(\"tChronometerStart_1_STARTTIME\"))");
                        log4jParamters_tMap_3.append(" | ");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_TEMPLATE_TALEND_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_TEMPLATE_TALEND_" + pid +"_tHashOutput_1");
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(Log_Out.SUCCESS_STATUT)							
				);
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(Log_Out.FileNamePOutPut)							
				);
		...
		int tos_count_tAdvancedHash_row7 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// source node:tHashInput_3 - inputs:(after_tHashInput_1) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_TEMPLATE_TALEND_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_TEMPLATE_TALEND_" + pid +"_tHashOutput_2");
		...
		int tos_count_tAdvancedHash_row5 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// source node:tHashInput_2 - inputs:(after_tDBInput_1) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_TEMPLATE_TALEND_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tHashInput_2","FOURNISSEUR","tHashInput","tAdvancedHash_row5","tAdvancedHash_row5","tAdvancedHash"
...
tHash_Lookup_row5.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row5",2,0,
			 			"tHashInput_2","FOURNISSEUR","tHashInput","tAdvancedHash_row5","tAdvancedHash_row5","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	{
                if(log.isDebugEnabled())
            log.debug("tDBClose_3 - "  + ("Closing the connection ")  + ("conn_tDBConnection_4")  + (" to the database.") );
        conn_tDBClose_3.close();
                if(log.isDebugEnabled())
            log.debug("tDBClose_3 - "  + ("Connection ")  + ("conn_tDBConnection_4")  + (" to the database has closed.") );
	}
 ...
 */
	...
	currentComponent="tLogRow_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row11","tFlowMeterCatcher_1","tFlowMeterCatcher_1","tFlowMeterCatcher","tLogRow_2","Meter_Log","tLogRow"
...
///////////////////////		
				...
				strBuffer_tLogRow_2.append(
				                String.valueOf(row11.reference)							
				);
...
///////////////////////    			
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row11",2,0,
			 			"tFlowMeterCatcher_1","tFlowMeterCatcher_1","tFlowMeterCatcher","tLogRow_2","Meter_Log","tLogRow","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TEMPLATE_TALEND.class.getClassLoader().getResourceAsStream("bi_team_projects/template_talend_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TEMPLATE_TALEND.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("REJET", "id_String");
                        if(context.getStringValue("REJET") == null) {
                            context.REJET = null;
                        } else {
                            context.REJET=(String) context.getProperty("REJET");
                        }
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("host")) {
            ...
            }if (parentContextMap.containsKey("REJET")) {
                context.REJET = (String) parentContextMap.get("REJET");
            }
        }
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TEMPLATE_TALEND");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     711482 characters generated by Talend Cloud Data Management Platform 
 *     on the 28 juillet 2022 à 15:17:38 WEST
 ************************************************************************************************/