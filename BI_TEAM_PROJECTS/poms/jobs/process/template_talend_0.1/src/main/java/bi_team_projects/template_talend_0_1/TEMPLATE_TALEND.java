            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tChronometerStop_1{
                    ...
                    log4jParamters_tChronometerStop_1.append("Parameters:");
                        ...
                        log4jParamters_tChronometerStop_1.append(" | ");
                            log4jParamters_tChronometerStop_1.append("DISPLAY_READABLE_DURATION" + " = " + "true");
                        log4jParamters_tChronometerStop_1.append(" | ");
                if(log.isDebugEnabled())
	...
	long timetChronometerStop_1;
		...
		timetChronometerStop_1 = System.currentTimeMillis() - startTime;
	    	...
	    	System.out.print("   " + timetChronometerStop_1/1000 + "seconds   ");
				...
				log.info("tChronometerStop_1 - Readable duration : "+ timetChronometerStop_1/1000 + " seconds");
...
/************************************************************************************************
 *     605801 characters generated by Talend Cloud Data Management Platform 
 *     on the 26 juillet 2022 à 17:04:52 WEST
 ************************************************************************************************/