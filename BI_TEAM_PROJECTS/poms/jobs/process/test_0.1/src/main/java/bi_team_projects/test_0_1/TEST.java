...
// # Output table : 'Log_Out'
						...
						Log_Out_tmp.ERROR_STATUT = row9.STATUT == Integer.valueOf("1") ? String.valueOf("KO")
								: String.valueOf("OK");
...
/************************************************************************************************
 * 598030 characters generated by Talend Cloud Data Management Platform on the
 * 26 juillet 2022 à 14:28:12 WEST
 ************************************************************************************************/