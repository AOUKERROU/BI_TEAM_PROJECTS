...
// # Output table : 'Log_Out'
						...
						Log_Out_tmp.ERROR_STATUT = row9.ERROR_STATUT != Integer.parseInt("1")
								|| row9.ERROR_STATUT == null ? String.valueOf("KO") : String.valueOf("OK");
...
/************************************************************************************************
 * 603125 characters generated by Talend Cloud Data Management Platform on the
 * 26 juillet 2022 à 16:59:17 WEST
 ************************************************************************************************/