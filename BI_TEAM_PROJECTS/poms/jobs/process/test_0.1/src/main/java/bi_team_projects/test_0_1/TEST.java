...
// # Output table : 'Log_Out'
						...
						Log_Out_tmp.STATUT = row9.STATUT != Integer.parseInt("1") || row9.STATUT == null
								? String.valueOf("KO")
								: String.valueOf("OK");
...
/************************************************************************************************
 * 600358 characters generated by Talend Cloud Data Management Platform on the
 * 26 juillet 2022 à 16:49:08 WEST
 ************************************************************************************************/