...
// # Output table : 'Log_Out'
						...
						Log_Out_tmp.STATUT = row9.STATUT == Integer.parseInt("1") ? String.valueOf("KO")
								: String.valueOf("OK");
...
/************************************************************************************************
 * 597897 characters generated by Talend Cloud Data Management Platform on the
 * 26 juillet 2022 à 14:39:53 WEST
 ************************************************************************************************/