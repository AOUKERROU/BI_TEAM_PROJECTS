...
// # Output table : 'Log_Out'
						...
						Log_Out_tmp.ERROR_STATUT = String
								.valueOf(row9.STATUT) = String.valueOf(1) ? String.valueOf("KO") : String.valueOf("OK");
...
/************************************************************************************************
 * 598042 characters generated by Talend Cloud Data Management Platform on the
 * 26 juillet 2022 à 14:20:36 WEST
 ************************************************************************************************/