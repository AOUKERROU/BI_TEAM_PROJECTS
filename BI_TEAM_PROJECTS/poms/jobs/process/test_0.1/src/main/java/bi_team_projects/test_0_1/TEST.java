...
// # Output table : 'Log_Out'
						...
						Log_Out_tmp.STATUT = row9.STATUT == 1 ? String.valueOf("KO") : String.valueOf("OK");
...
///////////////////////		
						...
						if (Log_Out.STATUT != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(Log_Out.STATUT));
...
/************************************************************************************************
 * 597903 characters generated by Talend Cloud Data Management Platform on the
 * 26 juillet 2022 à 14:31:00 WEST
 ************************************************************************************************/