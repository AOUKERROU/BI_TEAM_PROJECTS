...
row4Struct row4 = new row4Struct();
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"ODS_STOCK_HEBDO\"");
                        log4jParamters_tDBOutput_1.append(" | ");
    ...
    String tableName_tDBOutput_1 = null;
        ...
        if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
            tableName_tDBOutput_1 = ("ODS_STOCK_HEBDO");
        } else {
            tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("ODS_STOCK_HEBDO");
        }
            ...
            log.debug("tDBOutput_1 - "  + ("Truncate")  + (" table '")  + (tableName_tDBOutput_1)  + ("' has succeeded.") );
                ...
                String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1 + " (CODE_ENSEIGNE,CODE_INTERNE_ARTICLE,CODE_ARTICLE,CODE_SITE,LIB_ARTICLE,EAN,VALO_STOCK,QTE_STOCK,DATE_STOCK,LAST_MAJ_DATE) VALUES (?,?,?,?,?,?,?,?,?,?)";    
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "with vue_couche as\n (SELECT STOSITE,\n         STOCINL,\n         SUM(NVL(STOVALI, 0) + NVL(STOVALL, 0) - NVL(STOVALV,"
...
+"QTE_STOCK > 0\n   AND vue_couche.STOSITE = vue_mvts.STMSITE (+)\n   AND vue_couche.STOCINL = vue_mvts.STMCINL (+)";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
					...
					if(rs_tDBInput_1.getObject(1) != null) {
						row1.CODE_ENSEIGNE = rs_tDBInput_1.getLong(1);
					} else {
					...
					if(rs_tDBInput_1.getObject(3) != null) {
						row1.CODE_ARTICLE = rs_tDBInput_1.getLong(3);
					} else {
					...
					if(rs_tDBInput_1.getObject(4) != null) {
						row1.CODE_SITE = rs_tDBInput_1.getLong(4);
					} else {
        	...
        	row1.LIB_ARTICLE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(6) != null) {
						row1.EAN = rs_tDBInput_1.getLong(6);
					} else {
					...
					if(rs_tDBInput_1.getObject(7) != null) {
						row1.VALO_STOCK = rs_tDBInput_1.getBigDecimal(7);
					} else {
					...
					if(rs_tDBInput_1.getObject(8) != null) {
						row1.QTE_STOCK = rs_tDBInput_1.getBigDecimal(8);
					} else {
        	...
        	row1.DATE_STOCK = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.LAST_MAJ_DATE = null;
							} else {
										
			row1.LAST_MAJ_DATE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 10);
		                    }
					...
					if(rs_tDBInput_1.getObject(11) != null) {
						row1.FOUCIN = rs_tDBInput_1.getInt(11);
					} else {
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.FOUCIN = row1.FOUCIN ;
...
out1_tmp.CODE_ENSEIGNE = row1.CODE_ENSEIGNE ;
out1_tmp.CODE_INTERNE_ARTICLE = row1.CODE_INTERNE_ARTICLE ;
out1_tmp.CODE_ARTICLE = row1.CODE_ARTICLE ;
out1_tmp.CODE_SITE = row1.CODE_SITE ;
out1_tmp.LIB_ARTICLE = row1.LIB_ARTICLE ;
out1_tmp.EAN = row1.EAN ;
out1_tmp.VALO_STOCK = row1.VALO_STOCK ;
out1_tmp.QTE_STOCK = row1.QTE_STOCK ;
out1_tmp.DATE_STOCK = TalendDate.parseDate("yyyy-MM-dd",row1.DATE_STOCK) ;
out1_tmp.LAST_MAJ_DATE = row1.LAST_MAJ_DATE ;
out1 = out1_tmp;
...
fouci_tmp.FOUCIN = row5.FOUCIN ;
fouci_tmp.NOM_FRNS = row5.LIBFRS ;
fouci_tmp.CNUF = row5.FOUCNUF ;
fouci = fouci_tmp;
...
} else {pstmt_tDBOutput_1.setLong(1, out1.CODE_ENSEIGNE);
}

                        if(out1.CODE_INTERNE_ARTICLE == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(2, out1.CODE_INTERNE_ARTICLE);
}

                        if(out1.CODE_ARTICLE == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(3, out1.CODE_ARTICLE);
}

                        if(out1.CODE_SITE == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(4, out1.CODE_SITE);
}

                        if(out1.LIB_ARTICLE == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, out1.LIB_ARTICLE);
}

                        if(out1.EAN == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(6, out1.EAN);
}

                        pstmt_tDBOutput_1.setBigDecimal(7, out1.VALO_STOCK);

                        pstmt_tDBOutput_1.setBigDecimal(8, out1.QTE_STOCK);

                        if(out1.DATE_STOCK != null) {
pstmt_tDBOutput_1.setObject(9, new java.sql.Timestamp(out1.DATE_STOCK.getTime()),java.sql.Types.DATE);
} else {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.DATE);
}

                        if(out1.LAST_MAJ_DATE != null) {
pstmt_tDBOutput_1.setObject(10, new java.sql.Timestamp(out1.LAST_MAJ_DATE.getTime()),java.sql.Types.DATE);
} else {
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row4.FOUCIN = aggregated_row_tAggregateRow_1.FOUCIN;
            				    
            				    row4.NOM_FRNS = aggregated_row_tAggregateRow_1.NOM_FRNS;
            				    
            				    row4.CNUF = aggregated_row_tAggregateRow_1.CNUF;
 ...
 */
	...
	currentComponent="tHashOutput_2";
		...
		row4Struct oneRow_tHashOutput_2 = new row4Struct();
					...
					oneRow_tHashOutput_2.FOUCIN = row4.FOUCIN;
					oneRow_tHashOutput_2.NOM_FRNS = row4.NOM_FRNS;
					oneRow_tHashOutput_2.CNUF = row4.CNUF;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_4";
		...
		int tos_count_tDBConnection_4 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_4{
                    ...
                    log4jParamters_tDBConnection_4.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_4.append(" | ");
                            log4jParamters_tDBConnection_4.append("SHARE_IDENTITY_SETTING" + " = " + "true");
                        log4jParamters_tDBConnection_4.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBConnection_4", "MSS AZURE", "tMSSqlConnection");
				talendJobLogProcess(globalMap);
			}
	...
	globalMap.put("shareIdentitySetting_tDBConnection_4",  true);
...
row8Struct row8 = new row8Struct();
	...
	currentComponent="tDBOutput_3";
		...
		int tos_count_tDBOutput_3 = 0;
                ...
                class BytesLimit65535_tDBOutput_3{
                    ...
                    log4jParamters_tDBOutput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("CONNECTION" + " = " + "tDBConnection_4");
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("TABLE" + " = " + "\"StockParArticleTT\"");
                        log4jParamters_tDBOutput_3.append(" | ");
                        ...
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("USE_FIELD_OPTIONS" + " = " + "true");
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("FIELD_OPTIONS" + " = " + "[{UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODEENSEIGNE")+"}, {UPDATE_KEY="+("true")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODE_INTERNE_ARTICLE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODE_ARTICLE")+"}, {UPDATE_KEY="+("true")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("CODESITE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("LIBARTICLE")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("EAN")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("VALO_STOCK")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("QTE_STOCK")+"}, {UPDATE_KEY="+("true")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("DATE_STOCK")+"}, {UPDATE_KEY="+("false")+", DELETE_KEY="+("false")+", UPDATABLE="+("true")+", INSERTABLE="+("true")+", SCHEMA_COLUMN="+("DateLastUpdateWebJob")+"}]");
                        log4jParamters_tDBOutput_3.append(" | ");
                        ...
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("BATCH_SIZE" + " = " + "50000");
                        log4jParamters_tDBOutput_3.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_3", "PORTAIL_FOURNISSEUR_AZURE", "tMSSqlOutput");
				talendJobLogProcess(globalMap);
			}
...
String dbUser_tDBOutput_3 = null;
	dbschema_tDBOutput_3 = (String)globalMap.get("dbschema_tDBConnection_4");
	
	conn_tDBOutput_3 = (java.sql.Connection)globalMap.get("conn_tDBConnection_4");
   ...
   int batchSize_tDBOutput_3 = 50000;
   int batchSizeCounter_tDBOutput_3=0;

if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
    tableName_tDBOutput_3 = "StockParArticleTT";
} else {
    tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "].[" + "StockParArticleTT";
}
    ...
    java.sql.PreparedStatement pstmtUpdate_tDBOutput_3 = null;
        String insert_tDBOutput_3 = "INSERT INTO [" + tableName_tDBOutput_3 + "] ([CODEENSEIGNE],[CODE_INTERNE_ARTICLE],[CODE_ARTICLE],[CODESITE],[LIBARTICLE],[EAN],[VALO_STOCK],[QTE_STOCK],[DATE_STOCK],[DateLastUpdateWebJob]) VALUES (?,?,?,?,?,?,?,?,?,?)";
        pstmt_tDBOutput_3 = conn_tDBOutput_3.prepareStatement(insert_tDBOutput_3);
        resourceMap.put("pstmt_tDBOutput_3", pstmt_tDBOutput_3);

 	boolean isShareIdentity_tDBOutput_3 = globalMap.get("shareIdentitySetting_tDBConnection_4") != null && (Boolean)globalMap.get("shareIdentitySetting_tDBConnection_4") == true;
 ...
 */
	...
	currentComponent="tMap_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_3","ORACLE_ODS","tOracleInput","tMap_2","tMap_1","tMap"
...
if(OUT_AZURE != null) { 
	...
	currentComponent="tUniqRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"OUT_AZURE","tMap_2","tMap_1","tMap","tUniqRow_1","tUniqRow_1","tUniqRow"
...
if(row8 != null) { 
	...
	currentComponent="tDBOutput_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row8","tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_3","PORTAIL_FOURNISSEUR_AZURE","tMSSqlOutput"
...
} else {pstmt_tDBOutput_3.setLong(1, row8.CODEENSEIGNE);
}

                    if(row8.CODE_INTERNE_ARTICLE == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setLong(2, row8.CODE_INTERNE_ARTICLE);
}

                    if(row8.CODE_ARTICLE == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setLong(3, row8.CODE_ARTICLE);
}

                    if(row8.CODESITE == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setLong(4, row8.CODESITE);
}

                    if(row8.LIBARTICLE == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, row8.LIBARTICLE);
}

                    if(row8.EAN == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setLong(6, row8.EAN);
}

                    pstmt_tDBOutput_3.setBigDecimal(7, row8.VALO_STOCK);

                    pstmt_tDBOutput_3.setBigDecimal(8, row8.QTE_STOCK);

                    if(row8.DATE_STOCK != null) {
pstmt_tDBOutput_3.setTimestamp(9, new java.sql.Timestamp(row8.DATE_STOCK.getTime()));
} else {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.TIMESTAMP);
}

                    if(row8.DateLastUpdateWebJob != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(row8.DateLastUpdateWebJob.getTime()));
} else {
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'OUT_AZURE': " + count_OUT_AZURE_tMap_2 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_3","ORACLE_ODS","tOracleInput","tMap_2","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
	...
	log.info("tUniqRow_1 - Duplicate records count: " + (nb_duplicates_tUniqRow_1)+" .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"OUT_AZURE",2,0,
			 			"tMap_2","tMap_1","tMap","tUniqRow_1","tUniqRow_1","tUniqRow","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row8",2,0,
			 			"tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_3","PORTAIL_FOURNISSEUR_AZURE","tMSSqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBCommit_1{
                    ...
                    log4jParamters_tDBCommit_1.append("Parameters:");
                            log4jParamters_tDBCommit_1.append("CONNECTION" + " = " + "tDBConnection_4");
 ...
 */
	...
	java.sql.Connection conn_tDBCommit_1 = (java.sql.Connection)globalMap.get("conn_tDBConnection_4");
	if(conn_tDBCommit_1 != null && !conn_tDBCommit_1.isClosed())
	{
	
			
	    		log.debug("tDBCommit_1 - Connection 'tDBConnection_4' starting to commit.");
			
			conn_tDBCommit_1.commit();
			
	    		log.debug("tDBCommit_1 - Connection 'tDBConnection_4' commit has succeeded.");
...
public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
                ...
                class BytesLimit65535_tDBRow_1{
                    ...
                    log4jParamters_tDBRow_1.append("Parameters:");
                        ...
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("CONNECTION" + " = " + "tDBConnection_4");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("IDENTITY_INSERT" + " = " + "false");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("QUERY" + " = " + "\"MERGE StockParArticle AS T  USING StockParArticleTT As S  ON S.CODESITE = T.CODESITE and S.CODE_INTERNE_ARTICLE = T.CODE_INTERNE_ARTICLE and S.DATE_STOCK = T.DATE_STOCK  WHEN NOT MATCHED THEN      INSERT (CODESITE,CODE_INTERNE_ARTICLE, DATE_STOCK,CODEENSEIGNE,CODE_ARTICLE,LIBARTICLE,EAN,VALO_STOCK,QTE_STOCK,DateLastUpdateWebJob)       VALUES (S.CODESITE,S.CODE_INTERNE_ARTICLE, S.DATE_STOCK,S.CODEENSEIGNE,S.CODE_ARTICLE,S.LIBARTICLE,S.EAN,S.VALO_STOCK,S.QTE_STOCK,SYSDATETIME())  WHEN MATCHED THEN UPDATE SET      T.VALO_STOCK = S.VALO_STOCK, T.CODEENSEIGNE = S.CODEENSEIGNE, T.LIBARTICLE= S.LIBARTICLE,      T.QTE_STOCK	= S.QTE_STOCK, T.CODE_ARTICLE= S.CODE_ARTICLE, T.EAN = S.EAN,   	DateLastUpdateWebJob= SYSDATETIME();  \"");
                        log4jParamters_tDBRow_1.append(" | ");
	...
	boolean whetherReject_tDBRow_1 = false;
				conn_tDBRow_1 = (java.sql.Connection)globalMap.get("conn_tDBConnection_4");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBCommit_2{
                    ...
                    log4jParamters_tDBCommit_2.append("Parameters:");
                            log4jParamters_tDBCommit_2.append("CONNECTION" + " = " + "tDBConnection_4");
 ...
 */
	...
	java.sql.Connection conn_tDBCommit_2 = (java.sql.Connection)globalMap.get("conn_tDBConnection_4");
	if(conn_tDBCommit_2 != null && !conn_tDBCommit_2.isClosed())
	{
		...
		try{
	    		...
	    		log.debug("tDBCommit_2 - Connection 'tDBConnection_4' starting to commit.");
			
			conn_tDBCommit_2.commit();
			
	    		log.debug("tDBCommit_2 - Connection 'tDBConnection_4' commit has succeeded.");
			
	
		}finally{
			
	    		log.debug("tDBCommit_2 - Closing the connection 'tDBConnection_4' to the database.");
			...
			if("com.mysql.cj.jdbc.Driver".equals((String)globalMap.get("driverClass_tDBConnection_4"))
	    		...
	    		log.debug("tDBCommit_2 - Connection 'tDBConnection_4' to the database closed.");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_2{
                    ...
                    log4jParamters_tWarn_2.append("Parameters:");
                            log4jParamters_tWarn_2.append("MESSAGE" + " = " + "\"Job OK\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Job OK","", "");
                if(log.isInfoEnabled())
            log.info("tWarn_2 - "  + ("Message: ")  + ("Job OK")  + (". Code: ")  + (42) );
	globalMap.put("tWarn_2_WARN_MESSAGES", "Job OK"); 
...
copyOfOUTFRNStruct copyOfOUTFRN = new copyOfOUTFRNStruct();
	...
	currentComponent="tFileOutputDelimited_2";
		...
		int tos_count_tFileOutputDelimited_2 = 0;
                ...
                class BytesLimit65535_tFileOutputDelimited_2{
                    ...
                    log4jParamters_tFileOutputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
                            log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = " + "context.PATH_STOCK_HEBDO+\"/FRNS_STOCK_HEBDO_\"+((String)globalMap.get(\"CurrentDate\"))+\".csv\"");
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileOutputDelimited_2", "tFileOutputDelimited_1", "tFileOutputDelimited");
				talendJobLogProcess(globalMap);
			}
			

String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.PATH_STOCK_HEBDO+"/FRNS_STOCK_HEBDO_"+((String)globalMap.get("CurrentDate"))+".csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_2 != null && directory_tFileOutputDelimited_2.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"UTF-8"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        outtFileOutputDelimited_2.write("FOUCFIN_FOURNISSEUR");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("LIBFRS_FOURNISSEUR");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("FOUCNUF_FOURNISSEUR");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("COUNTFRN");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
 ...
 */
	...
	currentComponent="tMap_4";
		...
		int tos_count_tMap_4 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tMap_4", "tMap_1", "tMap");
				talendJobLogProcess(globalMap);
			}
...
// ###############################
// # Outputs initialization
				int count_copyOfOUTFRN_tMap_4 = 0;
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		int tos_count_tHashInput_4 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tHashInput_4", "FOURNISSEEUR", "tHashInput");
				talendJobLogProcess(globalMap);
			}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_JOB_STOCK_HEBDO_" + pid +"_tHashOutput_1");
if(tHashFile_tHashInput_4==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row3Struct> iterator_tHashInput_4 = tHashFile_tHashInput_4.iterator();
while (iterator_tHashInput_4.hasNext()) {
    row3Struct next_tHashInput_4 = iterator_tHashInput_4.next();

	row9.FOUCFIN = next_tHashInput_4.FOUCFIN;
	row9.LIBFRS = next_tHashInput_4.LIBFRS;
	row9.FOUCNUF = next_tHashInput_4.FOUCNUF;
 ...
 */
	...
	currentComponent="tMap_4";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row9","tHashInput_4","FOURNISSEEUR","tHashInput","tMap_4","tMap_1","tMap"
...
log.debug("tMap_4 - Outputting the record " + count_copyOfOUTFRN_tMap_4 + " of the output table 'copyOfOUTFRN'.");
...
if(copyOfOUTFRN != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"copyOfOUTFRN","tMap_4","tMap_1","tMap","tFileOutputDelimited_2","tFileOutputDelimited_1","tFileOutputDelimited"
...
// ###############################      
				log.debug("tMap_4 - Written records count in the table 'copyOfOUTFRN': " + count_copyOfOUTFRN_tMap_4 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row9",2,0,
			 			"tHashInput_4","FOURNISSEEUR","tHashInput","tMap_4","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		resourceMap.put("finish_tFileOutputDelimited_2", true);
				...
				log.debug("tFileOutputDelimited_2 - Written records count: " + nb_line_tFileOutputDelimited_2 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"copyOfOUTFRN",2,0,
			 			"tMap_4","tMap_1","tMap","tFileOutputDelimited_2","tFileOutputDelimited_1","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileExist_2{
                    ...
                    log4jParamters_tFileExist_2.append("Parameters:");
                            log4jParamters_tFileExist_2.append("FILE_NAME" + " = " + "((String)globalMap.get(\"tFileOutputDelimited_2_FILE_NAME\"))");
...
java.io.File file_tFileExist_2 = new java.io.File(((String)globalMap.get("tFileOutputDelimited_2_FILE_NAME")));
...
globalMap.put("tFileExist_2_FILENAME",((String)globalMap.get("tFileOutputDelimited_2_FILE_NAME")));
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSendMail_2{
                    ...
                    log4jParamters_tSendMail_2.append("Parameters:");
                            log4jParamters_tSendMail_2.append("TO" + " = " + "\"souzzi@marjane.co.ma\"");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("FROM" + " = " + "\"Talend@marjane.co.ma\"");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("NEED_PERSONAL_NAME" + " = " + "false");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("CC" + " = " + "\"aoukerrou@marjane.co.ma ; zjaddy@marjane.co.ma\"");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("BCC" + " = " + "");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("SUBJECT" + " = " + "\"FRNS STOCK HEBDO\"");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("MESSAGE" + " = " + "\"Hello,  Merci de trouver ci-joint les fournisseurs de l'alimentation du Stock Hebdo.  Cordialement\"");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("CHECK_ATTACHMENT" + " = " + "true");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("ATTACHMENTS" + " = " + "[{CONTENT_TRANSFER_ENCODING="+("DEFAULT")+", FILE="+("((String)globalMap.get(\"tFileOutputDelimited_2_FILE_NAME\"))")+"}]");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("HEADERS" + " = " + "[]");
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("SMTP_HOST" + " = " + "\"192.168.99.103\"");
                        log4jParamters_tSendMail_2.append(" | ");
 ...
 */
	...
	String smtpHost_tSendMail_2 = "192.168.99.103";
        String smtpPort_tSendMail_2 = "25";
	String from_tSendMail_2 = ("Talend@marjane.co.ma");
    String to_tSendMail_2 = ("souzzi@marjane.co.ma").replace(";",",");
    String cc_tSendMail_2 = (("aoukerrou@marjane.co.ma ; zjaddy@marjane.co.ma")==null || "".equals("aoukerrou@marjane.co.ma ; zjaddy@marjane.co.ma"))?null:("aoukerrou@marjane.co.ma ; zjaddy@marjane.co.ma").replace(";",",");
    String bcc_tSendMail_2 = (("")==null || "".equals(""))?null:("").replace(";",",");
    String subject_tSendMail_2 = ("FRNS STOCK HEBDO");
		...
		int tos_count_tAdvancedHash_row10 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// source node:tHashInput_5 - inputs:(after_tHashInput_4) outputs:(row10,row10) | target node:tAdvancedHash_row10 - inputs:(row10) outputs:()
			   		// linked node: tMap_4 - inputs:(row9,row10) outputs:(copyOfOUTFRN)
 ...
 */
	...
	currentComponent="tHashInput_5";
		...
		int tos_count_tHashInput_5 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tHashInput_5", "COUNTFRN", "tHashInput");
				talendJobLogProcess(globalMap);
			}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_JOB_STOCK_HEBDO_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_5.hasNext()) {
	...
	row10.FOUCFIN = next_tHashInput_5.FOUCIN;
	row10.LIBFRS = next_tHashInput_5.NOM_FRNS;
	row10.FOUCNUF = next_tHashInput_5.CNUF;
	row10.COUNTFRN = next_tHashInput_5.CountFRN;
 ...
 */
	...
	currentComponent="tAdvancedHash_row10";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row10","tHashInput_5","COUNTFRN","tHashInput","tAdvancedHash_row10","tAdvancedHash_row10","tAdvancedHash"
...
tHash_Lookup_row10.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row10",2,0,
			 			"tHashInput_5","COUNTFRN","tHashInput","tAdvancedHash_row10","tAdvancedHash_row10","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
...
while (iterator_tHashInput_1.hasNext()) {
	...
	row5.FOUCIN = next_tHashInput_1.FOUCFIN;
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row5_HashRow.FOUCIN = row5.FOUCIN;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBClose_1";
		...
		int tos_count_tDBClose_1 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBClose_1", "GOLD", "tOracleClose");
				talendJobLogProcess(globalMap);
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBClose_2";
		...
		int tos_count_tDBClose_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBClose_2{
                    ...
                    log4jParamters_tDBClose_2.append("Parameters:");
                            log4jParamters_tDBClose_2.append("CONNECTION" + " = " + "tDBConnection_4");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBClose_2", "MSSERVER", "tMSSqlClose");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	java.sql.Connection conn_tDBClose_2 = (java.sql.Connection)globalMap.get("conn_tDBConnection_4");
	if(conn_tDBClose_2 != null && !conn_tDBClose_2.isClosed())
	{
                if(log.isDebugEnabled())
            log.debug("tDBClose_2 - "  + ("Closing the connection ")  + ("conn_tDBConnection_4")  + (" to the database.") );
        conn_tDBClose_2.close();
                if(log.isDebugEnabled())
            log.debug("tDBClose_2 - "  + ("Connection ")  + ("conn_tDBConnection_4")  + (" to the database has closed.") );
	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBClose_3";
		...
		int tos_count_tDBClose_3 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBClose_3", "ODS", "tOracleClose");
				talendJobLogProcess(globalMap);
			}
...
/************************************************************************************************
 *     596523 characters generated by Talend Cloud Data Management Platform 
 *     on the 4 août 2022 à 11:55:46 WEST
 ************************************************************************************************/